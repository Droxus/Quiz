const tf=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerpolicy&&(r.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?r.credentials="include":i.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}};tf();function Go(t,e){const n=Object.create(null),s=t.split(",");for(let i=0;i<s.length;i++)n[s[i]]=!0;return e?i=>!!n[i.toLowerCase()]:i=>!!n[i]}const nf="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",sf=Go(nf);function qc(t){return!!t||t===""}function $o(t){if(q(t)){const e={};for(let n=0;n<t.length;n++){const s=t[n],i=Oe(s)?af(s):$o(s);if(i)for(const r in i)e[r]=i[r]}return e}else{if(Oe(t))return t;if(Pe(t))return t}}const rf=/;(?![^(]*\))/g,of=/:(.+)/;function af(t){const e={};return t.split(rf).forEach(n=>{if(n){const s=n.split(of);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function Uo(t){let e="";if(Oe(t))e=t;else if(q(t))for(let n=0;n<t.length;n++){const s=Uo(t[n]);s&&(e+=s+" ")}else if(Pe(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const KC=t=>Oe(t)?t:t==null?"":q(t)||Pe(t)&&(t.toString===Kc||!Q(t.toString))?JSON.stringify(t,Vc,2):String(t),Vc=(t,e)=>e&&e.__v_isRef?Vc(t,e.value):Zn(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[s,i])=>(n[`${s} =>`]=i,n),{})}:zc(e)?{[`Set(${e.size})`]:[...e.values()]}:Pe(e)&&!q(e)&&!Yc(e)?String(e):e,fe={},Jn=[],pt=()=>{},lf=()=>!1,cf=/^on[^a-z]/,rr=t=>cf.test(t),Wo=t=>t.startsWith("onUpdate:"),je=Object.assign,Ho=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},uf=Object.prototype.hasOwnProperty,Z=(t,e)=>uf.call(t,e),q=Array.isArray,Zn=t=>or(t)==="[object Map]",zc=t=>or(t)==="[object Set]",Q=t=>typeof t=="function",Oe=t=>typeof t=="string",jo=t=>typeof t=="symbol",Pe=t=>t!==null&&typeof t=="object",Qc=t=>Pe(t)&&Q(t.then)&&Q(t.catch),Kc=Object.prototype.toString,or=t=>Kc.call(t),df=t=>or(t).slice(8,-1),Yc=t=>or(t)==="[object Object]",qo=t=>Oe(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Pi=Go(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),ar=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},hf=/-(\w)/g,Pt=ar(t=>t.replace(hf,(e,n)=>n?n.toUpperCase():"")),ff=/\B([A-Z])/g,gs=ar(t=>t.replace(ff,"-$1").toLowerCase()),lr=ar(t=>t.charAt(0).toUpperCase()+t.slice(1)),Sr=ar(t=>t?`on${lr(t)}`:""),Qs=(t,e)=>!Object.is(t,e),Pr=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},Di=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},mf=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let tl;const pf=()=>tl||(tl=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});let kt;class gf{constructor(e=!1){this.active=!0,this.effects=[],this.cleanups=[],!e&&kt&&(this.parent=kt,this.index=(kt.scopes||(kt.scopes=[])).push(this)-1)}run(e){if(this.active){const n=kt;try{return kt=this,e()}finally{kt=n}}}on(){kt=this}off(){kt=this.parent}stop(e){if(this.active){let n,s;for(n=0,s=this.effects.length;n<s;n++)this.effects[n].stop();for(n=0,s=this.cleanups.length;n<s;n++)this.cleanups[n]();if(this.scopes)for(n=0,s=this.scopes.length;n<s;n++)this.scopes[n].stop(!0);if(this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.active=!1}}}function _f(t,e=kt){e&&e.active&&e.effects.push(t)}const Vo=t=>{const e=new Set(t);return e.w=0,e.n=0,e},Xc=t=>(t.w&ln)>0,Jc=t=>(t.n&ln)>0,yf=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=ln},Ef=t=>{const{deps:e}=t;if(e.length){let n=0;for(let s=0;s<e.length;s++){const i=e[s];Xc(i)&&!Jc(i)?i.delete(t):e[n++]=i,i.w&=~ln,i.n&=~ln}e.length=n}},Zr=new WeakMap;let Ls=0,ln=1;const eo=30;let dt;const Cn=Symbol(""),to=Symbol("");class zo{constructor(e,n=null,s){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,_f(this,s)}run(){if(!this.active)return this.fn();let e=dt,n=en;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=dt,dt=this,en=!0,ln=1<<++Ls,Ls<=eo?yf(this):nl(this),this.fn()}finally{Ls<=eo&&Ef(this),ln=1<<--Ls,dt=this.parent,en=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){dt===this?this.deferStop=!0:this.active&&(nl(this),this.onStop&&this.onStop(),this.active=!1)}}function nl(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let en=!0;const Zc=[];function _s(){Zc.push(en),en=!1}function ys(){const t=Zc.pop();en=t===void 0?!0:t}function tt(t,e,n){if(en&&dt){let s=Zr.get(t);s||Zr.set(t,s=new Map);let i=s.get(n);i||s.set(n,i=Vo()),eu(i)}}function eu(t,e){let n=!1;Ls<=eo?Jc(t)||(t.n|=ln,n=!Xc(t)):n=!t.has(dt),n&&(t.add(dt),dt.deps.push(t))}function Ut(t,e,n,s,i,r){const o=Zr.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&q(t))o.forEach((l,c)=>{(c==="length"||c>=s)&&a.push(l)});else switch(n!==void 0&&a.push(o.get(n)),e){case"add":q(t)?qo(n)&&a.push(o.get("length")):(a.push(o.get(Cn)),Zn(t)&&a.push(o.get(to)));break;case"delete":q(t)||(a.push(o.get(Cn)),Zn(t)&&a.push(o.get(to)));break;case"set":Zn(t)&&a.push(o.get(Cn));break}if(a.length===1)a[0]&&no(a[0]);else{const l=[];for(const c of a)c&&l.push(...c);no(Vo(l))}}function no(t,e){const n=q(t)?t:[...t];for(const s of n)s.computed&&sl(s);for(const s of n)s.computed||sl(s)}function sl(t,e){(t!==dt||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}const vf=Go("__proto__,__v_isRef,__isVue"),tu=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(jo)),wf=Qo(),Cf=Qo(!1,!0),bf=Qo(!0),il=If();function If(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const s=ne(this);for(let r=0,o=this.length;r<o;r++)tt(s,"get",r+"");const i=s[e](...n);return i===-1||i===!1?s[e](...n.map(ne)):i}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){_s();const s=ne(this)[e].apply(this,n);return ys(),s}}),t}function Qo(t=!1,e=!1){return function(s,i,r){if(i==="__v_isReactive")return!t;if(i==="__v_isReadonly")return t;if(i==="__v_isShallow")return e;if(i==="__v_raw"&&r===(t?e?$f:ou:e?ru:iu).get(s))return s;const o=q(s);if(!t&&o&&Z(il,i))return Reflect.get(il,i,r);const a=Reflect.get(s,i,r);return(jo(i)?tu.has(i):vf(i))||(t||tt(s,"get",i),e)?a:Ge(a)?o&&qo(i)?a:a.value:Pe(a)?t?au(a):fi(a):a}}const kf=nu(),Tf=nu(!0);function nu(t=!1){return function(n,s,i,r){let o=n[s];if(Ks(o)&&Ge(o)&&!Ge(i))return!1;if(!t&&!Ks(i)&&(so(i)||(i=ne(i),o=ne(o)),!q(n)&&Ge(o)&&!Ge(i)))return o.value=i,!0;const a=q(n)&&qo(s)?Number(s)<n.length:Z(n,s),l=Reflect.set(n,s,i,r);return n===ne(r)&&(a?Qs(i,o)&&Ut(n,"set",s,i):Ut(n,"add",s,i)),l}}function Af(t,e){const n=Z(t,e);t[e];const s=Reflect.deleteProperty(t,e);return s&&n&&Ut(t,"delete",e,void 0),s}function Rf(t,e){const n=Reflect.has(t,e);return(!jo(e)||!tu.has(e))&&tt(t,"has",e),n}function Sf(t){return tt(t,"iterate",q(t)?"length":Cn),Reflect.ownKeys(t)}const su={get:wf,set:kf,deleteProperty:Af,has:Rf,ownKeys:Sf},Pf={get:bf,set(t,e){return!0},deleteProperty(t,e){return!0}},xf=je({},su,{get:Cf,set:Tf}),Ko=t=>t,cr=t=>Reflect.getPrototypeOf(t);function wi(t,e,n=!1,s=!1){t=t.__v_raw;const i=ne(t),r=ne(e);n||(e!==r&&tt(i,"get",e),tt(i,"get",r));const{has:o}=cr(i),a=s?Ko:n?Jo:Ys;if(o.call(i,e))return a(t.get(e));if(o.call(i,r))return a(t.get(r));t!==i&&t.get(e)}function Ci(t,e=!1){const n=this.__v_raw,s=ne(n),i=ne(t);return e||(t!==i&&tt(s,"has",t),tt(s,"has",i)),t===i?n.has(t):n.has(t)||n.has(i)}function bi(t,e=!1){return t=t.__v_raw,!e&&tt(ne(t),"iterate",Cn),Reflect.get(t,"size",t)}function rl(t){t=ne(t);const e=ne(this);return cr(e).has.call(e,t)||(e.add(t),Ut(e,"add",t,t)),this}function ol(t,e){e=ne(e);const n=ne(this),{has:s,get:i}=cr(n);let r=s.call(n,t);r||(t=ne(t),r=s.call(n,t));const o=i.call(n,t);return n.set(t,e),r?Qs(e,o)&&Ut(n,"set",t,e):Ut(n,"add",t,e),this}function al(t){const e=ne(this),{has:n,get:s}=cr(e);let i=n.call(e,t);i||(t=ne(t),i=n.call(e,t)),s&&s.call(e,t);const r=e.delete(t);return i&&Ut(e,"delete",t,void 0),r}function ll(){const t=ne(this),e=t.size!==0,n=t.clear();return e&&Ut(t,"clear",void 0,void 0),n}function Ii(t,e){return function(s,i){const r=this,o=r.__v_raw,a=ne(o),l=e?Ko:t?Jo:Ys;return!t&&tt(a,"iterate",Cn),o.forEach((c,u)=>s.call(i,l(c),l(u),r))}}function ki(t,e,n){return function(...s){const i=this.__v_raw,r=ne(i),o=Zn(r),a=t==="entries"||t===Symbol.iterator&&o,l=t==="keys"&&o,c=i[t](...s),u=n?Ko:e?Jo:Ys;return!e&&tt(r,"iterate",l?to:Cn),{next(){const{value:d,done:h}=c.next();return h?{value:d,done:h}:{value:a?[u(d[0]),u(d[1])]:u(d),done:h}},[Symbol.iterator](){return this}}}}function qt(t){return function(...e){return t==="delete"?!1:this}}function Nf(){const t={get(r){return wi(this,r)},get size(){return bi(this)},has:Ci,add:rl,set:ol,delete:al,clear:ll,forEach:Ii(!1,!1)},e={get(r){return wi(this,r,!1,!0)},get size(){return bi(this)},has:Ci,add:rl,set:ol,delete:al,clear:ll,forEach:Ii(!1,!0)},n={get(r){return wi(this,r,!0)},get size(){return bi(this,!0)},has(r){return Ci.call(this,r,!0)},add:qt("add"),set:qt("set"),delete:qt("delete"),clear:qt("clear"),forEach:Ii(!0,!1)},s={get(r){return wi(this,r,!0,!0)},get size(){return bi(this,!0)},has(r){return Ci.call(this,r,!0)},add:qt("add"),set:qt("set"),delete:qt("delete"),clear:qt("clear"),forEach:Ii(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=ki(r,!1,!1),n[r]=ki(r,!0,!1),e[r]=ki(r,!1,!0),s[r]=ki(r,!0,!0)}),[t,n,e,s]}const[Mf,Of,Lf,Bf]=Nf();function Yo(t,e){const n=e?t?Bf:Lf:t?Of:Mf;return(s,i,r)=>i==="__v_isReactive"?!t:i==="__v_isReadonly"?t:i==="__v_raw"?s:Reflect.get(Z(n,i)&&i in s?n:s,i,r)}const Df={get:Yo(!1,!1)},Ff={get:Yo(!1,!0)},Gf={get:Yo(!0,!1)},iu=new WeakMap,ru=new WeakMap,ou=new WeakMap,$f=new WeakMap;function Uf(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Wf(t){return t.__v_skip||!Object.isExtensible(t)?0:Uf(df(t))}function fi(t){return Ks(t)?t:Xo(t,!1,su,Df,iu)}function Hf(t){return Xo(t,!1,xf,Ff,ru)}function au(t){return Xo(t,!0,Pf,Gf,ou)}function Xo(t,e,n,s,i){if(!Pe(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const r=i.get(t);if(r)return r;const o=Wf(t);if(o===0)return t;const a=new Proxy(t,o===2?s:n);return i.set(t,a),a}function es(t){return Ks(t)?es(t.__v_raw):!!(t&&t.__v_isReactive)}function Ks(t){return!!(t&&t.__v_isReadonly)}function so(t){return!!(t&&t.__v_isShallow)}function lu(t){return es(t)||Ks(t)}function ne(t){const e=t&&t.__v_raw;return e?ne(e):t}function cu(t){return Di(t,"__v_skip",!0),t}const Ys=t=>Pe(t)?fi(t):t,Jo=t=>Pe(t)?au(t):t;function uu(t){en&&dt&&(t=ne(t),eu(t.dep||(t.dep=Vo())))}function du(t,e){t=ne(t),t.dep&&no(t.dep)}function Ge(t){return!!(t&&t.__v_isRef===!0)}function jf(t){return hu(t,!1)}function qf(t){return hu(t,!0)}function hu(t,e){return Ge(t)?t:new Vf(t,e)}class Vf{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:ne(e),this._value=n?e:Ys(e)}get value(){return uu(this),this._value}set value(e){e=this.__v_isShallow?e:ne(e),Qs(e,this._rawValue)&&(this._rawValue=e,this._value=this.__v_isShallow?e:Ys(e),du(this))}}function ts(t){return Ge(t)?t.value:t}const zf={get:(t,e,n)=>ts(Reflect.get(t,e,n)),set:(t,e,n,s)=>{const i=t[e];return Ge(i)&&!Ge(n)?(i.value=n,!0):Reflect.set(t,e,n,s)}};function fu(t){return es(t)?t:new Proxy(t,zf)}class Qf{constructor(e,n,s,i){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this._dirty=!0,this.effect=new zo(e,()=>{this._dirty||(this._dirty=!0,du(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!i,this.__v_isReadonly=s}get value(){const e=ne(this);return uu(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function Kf(t,e,n=!1){let s,i;const r=Q(t);return r?(s=t,i=pt):(s=t.get,i=t.set),new Qf(s,i,r||!i,n)}function tn(t,e,n,s){let i;try{i=s?t(...s):t()}catch(r){ur(r,e,n)}return i}function gt(t,e,n,s){if(Q(t)){const r=tn(t,e,n,s);return r&&Qc(r)&&r.catch(o=>{ur(o,e,n)}),r}const i=[];for(let r=0;r<t.length;r++)i.push(gt(t[r],e,n,s));return i}function ur(t,e,n,s=!0){const i=e?e.vnode:null;if(e){let r=e.parent;const o=e.proxy,a=n;for(;r;){const c=r.ec;if(c){for(let u=0;u<c.length;u++)if(c[u](t,o,a)===!1)return}r=r.parent}const l=e.appContext.config.errorHandler;if(l){tn(l,null,10,[t,o,a]);return}}Yf(t,n,i,s)}function Yf(t,e,n,s=!0){console.error(t)}let Fi=!1,io=!1;const Ze=[];let Dt=0;const Gs=[];let Bs=null,zn=0;const $s=[];let Qt=null,Qn=0;const mu=Promise.resolve();let Zo=null,ro=null;function pu(t){const e=Zo||mu;return t?e.then(this?t.bind(this):t):e}function Xf(t){let e=Dt+1,n=Ze.length;for(;e<n;){const s=e+n>>>1;Xs(Ze[s])<t?e=s+1:n=s}return e}function gu(t){(!Ze.length||!Ze.includes(t,Fi&&t.allowRecurse?Dt+1:Dt))&&t!==ro&&(t.id==null?Ze.push(t):Ze.splice(Xf(t.id),0,t),_u())}function _u(){!Fi&&!io&&(io=!0,Zo=mu.then(vu))}function Jf(t){const e=Ze.indexOf(t);e>Dt&&Ze.splice(e,1)}function yu(t,e,n,s){q(t)?n.push(...t):(!e||!e.includes(t,t.allowRecurse?s+1:s))&&n.push(t),_u()}function Zf(t){yu(t,Bs,Gs,zn)}function em(t){yu(t,Qt,$s,Qn)}function dr(t,e=null){if(Gs.length){for(ro=e,Bs=[...new Set(Gs)],Gs.length=0,zn=0;zn<Bs.length;zn++)Bs[zn]();Bs=null,zn=0,ro=null,dr(t,e)}}function Eu(t){if(dr(),$s.length){const e=[...new Set($s)];if($s.length=0,Qt){Qt.push(...e);return}for(Qt=e,Qt.sort((n,s)=>Xs(n)-Xs(s)),Qn=0;Qn<Qt.length;Qn++)Qt[Qn]();Qt=null,Qn=0}}const Xs=t=>t.id==null?1/0:t.id;function vu(t){io=!1,Fi=!0,dr(t),Ze.sort((n,s)=>Xs(n)-Xs(s));const e=pt;try{for(Dt=0;Dt<Ze.length;Dt++){const n=Ze[Dt];n&&n.active!==!1&&tn(n,null,14)}}finally{Dt=0,Ze.length=0,Eu(),Fi=!1,Zo=null,(Ze.length||Gs.length||$s.length)&&vu(t)}}function tm(t,e,...n){if(t.isUnmounted)return;const s=t.vnode.props||fe;let i=n;const r=e.startsWith("update:"),o=r&&e.slice(7);if(o&&o in s){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:d,trim:h}=s[u]||fe;h&&(i=n.map(g=>g.trim())),d&&(i=n.map(mf))}let a,l=s[a=Sr(e)]||s[a=Sr(Pt(e))];!l&&r&&(l=s[a=Sr(gs(e))]),l&&gt(l,t,6,i);const c=s[a+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,gt(c,t,6,i)}}function wu(t,e,n=!1){const s=e.emitsCache,i=s.get(t);if(i!==void 0)return i;const r=t.emits;let o={},a=!1;if(!Q(t)){const l=c=>{const u=wu(c,e,!0);u&&(a=!0,je(o,u))};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}return!r&&!a?(s.set(t,null),null):(q(r)?r.forEach(l=>o[l]=null):je(o,r),s.set(t,o),o)}function hr(t,e){return!t||!rr(e)?!1:(e=e.slice(2).replace(/Once$/,""),Z(t,e[0].toLowerCase()+e.slice(1))||Z(t,gs(e))||Z(t,e))}let Rt=null,Cu=null;function Gi(t){const e=Rt;return Rt=t,Cu=t&&t.type.__scopeId||null,e}function Ds(t,e=Rt,n){if(!e||t._n)return t;const s=(...i)=>{s._d&&yl(-1);const r=Gi(e),o=t(...i);return Gi(r),s._d&&yl(1),o};return s._n=!0,s._c=!0,s._d=!0,s}function xr(t){const{type:e,vnode:n,proxy:s,withProxy:i,props:r,propsOptions:[o],slots:a,attrs:l,emit:c,render:u,renderCache:d,data:h,setupState:g,ctx:y,inheritAttrs:x}=t;let k,N;const $=Gi(t);try{if(n.shapeFlag&4){const H=i||s;k=Tt(u.call(H,H,d,r,g,h,y)),N=l}else{const H=e;k=Tt(H.length>1?H(r,{attrs:l,slots:a,emit:c}):H(r,null)),N=e.props?l:nm(l)}}catch(H){Us.length=0,ur(H,t,1),k=Me(Tn)}let W=k;if(N&&x!==!1){const H=Object.keys(N),{shapeFlag:Ie}=W;H.length&&Ie&7&&(o&&H.some(Wo)&&(N=sm(N,o)),W=is(W,N))}return n.dirs&&(W=is(W),W.dirs=W.dirs?W.dirs.concat(n.dirs):n.dirs),n.transition&&(W.transition=n.transition),k=W,Gi($),k}const nm=t=>{let e;for(const n in t)(n==="class"||n==="style"||rr(n))&&((e||(e={}))[n]=t[n]);return e},sm=(t,e)=>{const n={};for(const s in t)(!Wo(s)||!(s.slice(9)in e))&&(n[s]=t[s]);return n};function im(t,e,n){const{props:s,children:i,component:r}=t,{props:o,children:a,patchFlag:l}=e,c=r.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&l>=0){if(l&1024)return!0;if(l&16)return s?cl(s,o,c):!!o;if(l&8){const u=e.dynamicProps;for(let d=0;d<u.length;d++){const h=u[d];if(o[h]!==s[h]&&!hr(c,h))return!0}}}else return(i||a)&&(!a||!a.$stable)?!0:s===o?!1:s?o?cl(s,o,c):!0:!!o;return!1}function cl(t,e,n){const s=Object.keys(e);if(s.length!==Object.keys(t).length)return!0;for(let i=0;i<s.length;i++){const r=s[i];if(e[r]!==t[r]&&!hr(n,r))return!0}return!1}function rm({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const om=t=>t.__isSuspense;function am(t,e){e&&e.pendingBranch?q(t)?e.effects.push(...t):e.effects.push(t):em(t)}function xi(t,e){if(De){let n=De.provides;const s=De.parent&&De.parent.provides;s===n&&(n=De.provides=Object.create(s)),n[t]=e}}function nn(t,e,n=!1){const s=De||Rt;if(s){const i=s.parent==null?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides;if(i&&t in i)return i[t];if(arguments.length>1)return n&&Q(e)?e.call(s.proxy):e}}const ul={};function Ni(t,e,n){return bu(t,e,n)}function bu(t,e,{immediate:n,deep:s,flush:i,onTrack:r,onTrigger:o}=fe){const a=De;let l,c=!1,u=!1;if(Ge(t)?(l=()=>t.value,c=so(t)):es(t)?(l=()=>t,s=!0):q(t)?(u=!0,c=t.some(N=>es(N)||so(N)),l=()=>t.map(N=>{if(Ge(N))return N.value;if(es(N))return Yn(N);if(Q(N))return tn(N,a,2)})):Q(t)?e?l=()=>tn(t,a,2):l=()=>{if(!(a&&a.isUnmounted))return d&&d(),gt(t,a,3,[h])}:l=pt,e&&s){const N=l;l=()=>Yn(N())}let d,h=N=>{d=k.onStop=()=>{tn(N,a,4)}};if(Zs)return h=pt,e?n&&gt(e,a,3,[l(),u?[]:void 0,h]):l(),pt;let g=u?[]:ul;const y=()=>{if(!!k.active)if(e){const N=k.run();(s||c||(u?N.some(($,W)=>Qs($,g[W])):Qs(N,g)))&&(d&&d(),gt(e,a,3,[N,g===ul?void 0:g,h]),g=N)}else k.run()};y.allowRecurse=!!e;let x;i==="sync"?x=y:i==="post"?x=()=>ze(y,a&&a.suspense):x=()=>Zf(y);const k=new zo(l,x);return e?n?y():g=k.run():i==="post"?ze(k.run.bind(k),a&&a.suspense):k.run(),()=>{k.stop(),a&&a.scope&&Ho(a.scope.effects,k)}}function lm(t,e,n){const s=this.proxy,i=Oe(t)?t.includes(".")?Iu(s,t):()=>s[t]:t.bind(s,s);let r;Q(e)?r=e:(r=e.handler,n=e);const o=De;rs(this);const a=bu(i,r.bind(s),n);return o?rs(o):bn(),a}function Iu(t,e){const n=e.split(".");return()=>{let s=t;for(let i=0;i<n.length&&s;i++)s=s[n[i]];return s}}function Yn(t,e){if(!Pe(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),Ge(t))Yn(t.value,e);else if(q(t))for(let n=0;n<t.length;n++)Yn(t[n],e);else if(zc(t)||Zn(t))t.forEach(n=>{Yn(n,e)});else if(Yc(t))for(const n in t)Yn(t[n],e);return t}function ku(t){return Q(t)?{setup:t,name:t.name}:t}const Mi=t=>!!t.type.__asyncLoader,Tu=t=>t.type.__isKeepAlive;function cm(t,e){Au(t,"a",e)}function um(t,e){Au(t,"da",e)}function Au(t,e,n=De){const s=t.__wdc||(t.__wdc=()=>{let i=n;for(;i;){if(i.isDeactivated)return;i=i.parent}return t()});if(fr(e,s,n),n){let i=n.parent;for(;i&&i.parent;)Tu(i.parent.vnode)&&dm(s,e,n,i),i=i.parent}}function dm(t,e,n,s){const i=fr(e,t,s,!0);Ru(()=>{Ho(s[e],i)},n)}function fr(t,e,n=De,s=!1){if(n){const i=n[t]||(n[t]=[]),r=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;_s(),rs(n);const a=gt(e,n,t,o);return bn(),ys(),a});return s?i.unshift(r):i.push(r),r}}const Ht=t=>(e,n=De)=>(!Zs||t==="sp")&&fr(t,e,n),hm=Ht("bm"),fm=Ht("m"),mm=Ht("bu"),pm=Ht("u"),gm=Ht("bum"),Ru=Ht("um"),_m=Ht("sp"),ym=Ht("rtg"),Em=Ht("rtc");function vm(t,e=De){fr("ec",t,e)}function hn(t,e,n,s){const i=t.dirs,r=e&&e.dirs;for(let o=0;o<i.length;o++){const a=i[o];r&&(a.oldValue=r[o].value);let l=a.dir[s];l&&(_s(),gt(l,n,8,[t.el,a,t,e]),ys())}}const Su="components";function Pu(t,e){return Cm(Su,t,!0,e)||t}const wm=Symbol();function Cm(t,e,n=!0,s=!1){const i=Rt||De;if(i){const r=i.type;if(t===Su){const a=Xm(r,!1);if(a&&(a===e||a===Pt(e)||a===lr(Pt(e))))return r}const o=dl(i[t]||r[t],e)||dl(i.appContext[t],e);return!o&&s?r:o}}function dl(t,e){return t&&(t[e]||t[Pt(e)]||t[lr(Pt(e))])}function YC(t,e,n,s){let i;const r=n&&n[s];if(q(t)||Oe(t)){i=new Array(t.length);for(let o=0,a=t.length;o<a;o++)i[o]=e(t[o],o,void 0,r&&r[o])}else if(typeof t=="number"){i=new Array(t);for(let o=0;o<t;o++)i[o]=e(o+1,o,void 0,r&&r[o])}else if(Pe(t))if(t[Symbol.iterator])i=Array.from(t,(o,a)=>e(o,a,void 0,r&&r[a]));else{const o=Object.keys(t);i=new Array(o.length);for(let a=0,l=o.length;a<l;a++){const c=o[a];i[a]=e(t[c],c,a,r&&r[a])}}else i=[];return n&&(n[s]=i),i}const oo=t=>t?qu(t)?sa(t)||t.proxy:oo(t.parent):null,$i=je(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>oo(t.parent),$root:t=>oo(t.root),$emit:t=>t.emit,$options:t=>Nu(t),$forceUpdate:t=>t.f||(t.f=()=>gu(t.update)),$nextTick:t=>t.n||(t.n=pu.bind(t.proxy)),$watch:t=>lm.bind(t)}),bm={get({_:t},e){const{ctx:n,setupState:s,data:i,props:r,accessCache:o,type:a,appContext:l}=t;let c;if(e[0]!=="$"){const g=o[e];if(g!==void 0)switch(g){case 1:return s[e];case 2:return i[e];case 4:return n[e];case 3:return r[e]}else{if(s!==fe&&Z(s,e))return o[e]=1,s[e];if(i!==fe&&Z(i,e))return o[e]=2,i[e];if((c=t.propsOptions[0])&&Z(c,e))return o[e]=3,r[e];if(n!==fe&&Z(n,e))return o[e]=4,n[e];ao&&(o[e]=0)}}const u=$i[e];let d,h;if(u)return e==="$attrs"&&tt(t,"get",e),u(t);if((d=a.__cssModules)&&(d=d[e]))return d;if(n!==fe&&Z(n,e))return o[e]=4,n[e];if(h=l.config.globalProperties,Z(h,e))return h[e]},set({_:t},e,n){const{data:s,setupState:i,ctx:r}=t;return i!==fe&&Z(i,e)?(i[e]=n,!0):s!==fe&&Z(s,e)?(s[e]=n,!0):Z(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(r[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:s,appContext:i,propsOptions:r}},o){let a;return!!n[o]||t!==fe&&Z(t,o)||e!==fe&&Z(e,o)||(a=r[0])&&Z(a,o)||Z(s,o)||Z($i,o)||Z(i.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:Z(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};let ao=!0;function Im(t){const e=Nu(t),n=t.proxy,s=t.ctx;ao=!1,e.beforeCreate&&hl(e.beforeCreate,t,"bc");const{data:i,computed:r,methods:o,watch:a,provide:l,inject:c,created:u,beforeMount:d,mounted:h,beforeUpdate:g,updated:y,activated:x,deactivated:k,beforeDestroy:N,beforeUnmount:$,destroyed:W,unmounted:H,render:Ie,renderTracked:Le,renderTriggered:at,errorCaptured:vt,serverPrefetch:wt,expose:jt,inheritAttrs:Mt,components:lt,directives:Ln,filters:Bn}=e;if(c&&km(c,s,null,t.appContext.config.unwrapInjectedRef),o)for(const ue in o){const ie=o[ue];Q(ie)&&(s[ue]=ie.bind(n))}if(i){const ue=i.call(n,n);Pe(ue)&&(t.data=fi(ue))}if(ao=!0,r)for(const ue in r){const ie=r[ue],Ye=Q(ie)?ie.bind(n,n):Q(ie.get)?ie.get.bind(n,n):pt,Fn=!Q(ie)&&Q(ie.set)?ie.set.bind(n):pt,Ot=rt({get:Ye,set:Fn});Object.defineProperty(s,ue,{enumerable:!0,configurable:!0,get:()=>Ot.value,set:Ct=>Ot.value=Ct})}if(a)for(const ue in a)xu(a[ue],s,n,ue);if(l){const ue=Q(l)?l.call(n):l;Reflect.ownKeys(ue).forEach(ie=>{xi(ie,ue[ie])})}u&&hl(u,t,"c");function ke(ue,ie){q(ie)?ie.forEach(Ye=>ue(Ye.bind(n))):ie&&ue(ie.bind(n))}if(ke(hm,d),ke(fm,h),ke(mm,g),ke(pm,y),ke(cm,x),ke(um,k),ke(vm,vt),ke(Em,Le),ke(ym,at),ke(gm,$),ke(Ru,H),ke(_m,wt),q(jt))if(jt.length){const ue=t.exposed||(t.exposed={});jt.forEach(ie=>{Object.defineProperty(ue,ie,{get:()=>n[ie],set:Ye=>n[ie]=Ye})})}else t.exposed||(t.exposed={});Ie&&t.render===pt&&(t.render=Ie),Mt!=null&&(t.inheritAttrs=Mt),lt&&(t.components=lt),Ln&&(t.directives=Ln)}function km(t,e,n=pt,s=!1){q(t)&&(t=lo(t));for(const i in t){const r=t[i];let o;Pe(r)?"default"in r?o=nn(r.from||i,r.default,!0):o=nn(r.from||i):o=nn(r),Ge(o)&&s?Object.defineProperty(e,i,{enumerable:!0,configurable:!0,get:()=>o.value,set:a=>o.value=a}):e[i]=o}}function hl(t,e,n){gt(q(t)?t.map(s=>s.bind(e.proxy)):t.bind(e.proxy),e,n)}function xu(t,e,n,s){const i=s.includes(".")?Iu(n,s):()=>n[s];if(Oe(t)){const r=e[t];Q(r)&&Ni(i,r)}else if(Q(t))Ni(i,t.bind(n));else if(Pe(t))if(q(t))t.forEach(r=>xu(r,e,n,s));else{const r=Q(t.handler)?t.handler.bind(n):e[t.handler];Q(r)&&Ni(i,r,t)}}function Nu(t){const e=t.type,{mixins:n,extends:s}=e,{mixins:i,optionsCache:r,config:{optionMergeStrategies:o}}=t.appContext,a=r.get(e);let l;return a?l=a:!i.length&&!n&&!s?l=e:(l={},i.length&&i.forEach(c=>Ui(l,c,o,!0)),Ui(l,e,o)),r.set(e,l),l}function Ui(t,e,n,s=!1){const{mixins:i,extends:r}=e;r&&Ui(t,r,n,!0),i&&i.forEach(o=>Ui(t,o,n,!0));for(const o in e)if(!(s&&o==="expose")){const a=Tm[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const Tm={data:fl,props:pn,emits:pn,methods:pn,computed:pn,beforeCreate:We,created:We,beforeMount:We,mounted:We,beforeUpdate:We,updated:We,beforeDestroy:We,beforeUnmount:We,destroyed:We,unmounted:We,activated:We,deactivated:We,errorCaptured:We,serverPrefetch:We,components:pn,directives:pn,watch:Rm,provide:fl,inject:Am};function fl(t,e){return e?t?function(){return je(Q(t)?t.call(this,this):t,Q(e)?e.call(this,this):e)}:e:t}function Am(t,e){return pn(lo(t),lo(e))}function lo(t){if(q(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function We(t,e){return t?[...new Set([].concat(t,e))]:e}function pn(t,e){return t?je(je(Object.create(null),t),e):e}function Rm(t,e){if(!t)return e;if(!e)return t;const n=je(Object.create(null),t);for(const s in e)n[s]=We(t[s],e[s]);return n}function Sm(t,e,n,s=!1){const i={},r={};Di(r,pr,1),t.propsDefaults=Object.create(null),Mu(t,e,i,r);for(const o in t.propsOptions[0])o in i||(i[o]=void 0);n?t.props=s?i:Hf(i):t.type.props?t.props=i:t.props=r,t.attrs=r}function Pm(t,e,n,s){const{props:i,attrs:r,vnode:{patchFlag:o}}=t,a=ne(i),[l]=t.propsOptions;let c=!1;if((s||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let d=0;d<u.length;d++){let h=u[d];if(hr(t.emitsOptions,h))continue;const g=e[h];if(l)if(Z(r,h))g!==r[h]&&(r[h]=g,c=!0);else{const y=Pt(h);i[y]=co(l,a,y,g,t,!1)}else g!==r[h]&&(r[h]=g,c=!0)}}}else{Mu(t,e,i,r)&&(c=!0);let u;for(const d in a)(!e||!Z(e,d)&&((u=gs(d))===d||!Z(e,u)))&&(l?n&&(n[d]!==void 0||n[u]!==void 0)&&(i[d]=co(l,a,d,void 0,t,!0)):delete i[d]);if(r!==a)for(const d in r)(!e||!Z(e,d)&&!0)&&(delete r[d],c=!0)}c&&Ut(t,"set","$attrs")}function Mu(t,e,n,s){const[i,r]=t.propsOptions;let o=!1,a;if(e)for(let l in e){if(Pi(l))continue;const c=e[l];let u;i&&Z(i,u=Pt(l))?!r||!r.includes(u)?n[u]=c:(a||(a={}))[u]=c:hr(t.emitsOptions,l)||(!(l in s)||c!==s[l])&&(s[l]=c,o=!0)}if(r){const l=ne(n),c=a||fe;for(let u=0;u<r.length;u++){const d=r[u];n[d]=co(i,l,d,c[d],t,!Z(c,d))}}return o}function co(t,e,n,s,i,r){const o=t[n];if(o!=null){const a=Z(o,"default");if(a&&s===void 0){const l=o.default;if(o.type!==Function&&Q(l)){const{propsDefaults:c}=i;n in c?s=c[n]:(rs(i),s=c[n]=l.call(null,e),bn())}else s=l}o[0]&&(r&&!a?s=!1:o[1]&&(s===""||s===gs(n))&&(s=!0))}return s}function Ou(t,e,n=!1){const s=e.propsCache,i=s.get(t);if(i)return i;const r=t.props,o={},a=[];let l=!1;if(!Q(t)){const u=d=>{l=!0;const[h,g]=Ou(d,e,!0);je(o,h),g&&a.push(...g)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!r&&!l)return s.set(t,Jn),Jn;if(q(r))for(let u=0;u<r.length;u++){const d=Pt(r[u]);ml(d)&&(o[d]=fe)}else if(r)for(const u in r){const d=Pt(u);if(ml(d)){const h=r[u],g=o[d]=q(h)||Q(h)?{type:h}:h;if(g){const y=_l(Boolean,g.type),x=_l(String,g.type);g[0]=y>-1,g[1]=x<0||y<x,(y>-1||Z(g,"default"))&&a.push(d)}}}const c=[o,a];return s.set(t,c),c}function ml(t){return t[0]!=="$"}function pl(t){const e=t&&t.toString().match(/^\s*function (\w+)/);return e?e[1]:t===null?"null":""}function gl(t,e){return pl(t)===pl(e)}function _l(t,e){return q(e)?e.findIndex(n=>gl(n,t)):Q(e)&&gl(e,t)?0:-1}const Lu=t=>t[0]==="_"||t==="$stable",ea=t=>q(t)?t.map(Tt):[Tt(t)],xm=(t,e,n)=>{if(e._n)return e;const s=Ds((...i)=>ea(e(...i)),n);return s._c=!1,s},Bu=(t,e,n)=>{const s=t._ctx;for(const i in t){if(Lu(i))continue;const r=t[i];if(Q(r))e[i]=xm(i,r,s);else if(r!=null){const o=ea(r);e[i]=()=>o}}},Du=(t,e)=>{const n=ea(e);t.slots.default=()=>n},Nm=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=ne(e),Di(e,"_",n)):Bu(e,t.slots={})}else t.slots={},e&&Du(t,e);Di(t.slots,pr,1)},Mm=(t,e,n)=>{const{vnode:s,slots:i}=t;let r=!0,o=fe;if(s.shapeFlag&32){const a=e._;a?n&&a===1?r=!1:(je(i,e),!n&&a===1&&delete i._):(r=!e.$stable,Bu(e,i)),o=e}else e&&(Du(t,e),o={default:1});if(r)for(const a in i)!Lu(a)&&!(a in o)&&delete i[a]};function Fu(){return{app:null,config:{isNativeTag:lf,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Om=0;function Lm(t,e){return function(s,i=null){Q(s)||(s=Object.assign({},s)),i!=null&&!Pe(i)&&(i=null);const r=Fu(),o=new Set;let a=!1;const l=r.app={_uid:Om++,_component:s,_props:i,_container:null,_context:r,_instance:null,version:Zm,get config(){return r.config},set config(c){},use(c,...u){return o.has(c)||(c&&Q(c.install)?(o.add(c),c.install(l,...u)):Q(c)&&(o.add(c),c(l,...u))),l},mixin(c){return r.mixins.includes(c)||r.mixins.push(c),l},component(c,u){return u?(r.components[c]=u,l):r.components[c]},directive(c,u){return u?(r.directives[c]=u,l):r.directives[c]},mount(c,u,d){if(!a){const h=Me(s,i);return h.appContext=r,u&&e?e(h,c):t(h,c,d),a=!0,l._container=c,c.__vue_app__=l,sa(h.component)||h.component.proxy}},unmount(){a&&(t(null,l._container),delete l._container.__vue_app__)},provide(c,u){return r.provides[c]=u,l}};return l}}function uo(t,e,n,s,i=!1){if(q(t)){t.forEach((h,g)=>uo(h,e&&(q(e)?e[g]:e),n,s,i));return}if(Mi(s)&&!i)return;const r=s.shapeFlag&4?sa(s.component)||s.component.proxy:s.el,o=i?null:r,{i:a,r:l}=t,c=e&&e.r,u=a.refs===fe?a.refs={}:a.refs,d=a.setupState;if(c!=null&&c!==l&&(Oe(c)?(u[c]=null,Z(d,c)&&(d[c]=null)):Ge(c)&&(c.value=null)),Q(l))tn(l,a,12,[o,u]);else{const h=Oe(l),g=Ge(l);if(h||g){const y=()=>{if(t.f){const x=h?u[l]:l.value;i?q(x)&&Ho(x,r):q(x)?x.includes(r)||x.push(r):h?(u[l]=[r],Z(d,l)&&(d[l]=u[l])):(l.value=[r],t.k&&(u[t.k]=l.value))}else h?(u[l]=o,Z(d,l)&&(d[l]=o)):g&&(l.value=o,t.k&&(u[t.k]=o))};o?(y.id=-1,ze(y,n)):y()}}}const ze=am;function Bm(t){return Dm(t)}function Dm(t,e){const n=pf();n.__VUE__=!0;const{insert:s,remove:i,patchProp:r,createElement:o,createText:a,createComment:l,setText:c,setElementText:u,parentNode:d,nextSibling:h,setScopeId:g=pt,cloneNode:y,insertStaticContent:x}=t,k=(f,m,_,w=null,v=null,T=null,P=!1,I=null,R=!!m.dynamicChildren)=>{if(f===m)return;f&&!ks(f,m)&&(w=D(f),nt(f,v,T,!0),f=null),m.patchFlag===-2&&(R=!1,m.dynamicChildren=null);const{type:C,ref:F,shapeFlag:L}=m;switch(C){case ta:N(f,m,_,w);break;case Tn:$(f,m,_,w);break;case Oi:f==null&&W(m,_,w,P);break;case Bt:Ln(f,m,_,w,v,T,P,I,R);break;default:L&1?Le(f,m,_,w,v,T,P,I,R):L&6?Bn(f,m,_,w,v,T,P,I,R):(L&64||L&128)&&C.process(f,m,_,w,v,T,P,I,R,de)}F!=null&&v&&uo(F,f&&f.ref,T,m||f,!m)},N=(f,m,_,w)=>{if(f==null)s(m.el=a(m.children),_,w);else{const v=m.el=f.el;m.children!==f.children&&c(v,m.children)}},$=(f,m,_,w)=>{f==null?s(m.el=l(m.children||""),_,w):m.el=f.el},W=(f,m,_,w)=>{[f.el,f.anchor]=x(f.children,m,_,w,f.el,f.anchor)},H=({el:f,anchor:m},_,w)=>{let v;for(;f&&f!==m;)v=h(f),s(f,_,w),f=v;s(m,_,w)},Ie=({el:f,anchor:m})=>{let _;for(;f&&f!==m;)_=h(f),i(f),f=_;i(m)},Le=(f,m,_,w,v,T,P,I,R)=>{P=P||m.type==="svg",f==null?at(m,_,w,v,T,P,I,R):jt(f,m,v,T,P,I,R)},at=(f,m,_,w,v,T,P,I)=>{let R,C;const{type:F,props:L,shapeFlag:G,transition:j,patchFlag:ee,dirs:oe}=f;if(f.el&&y!==void 0&&ee===-1)R=f.el=y(f.el);else{if(R=f.el=o(f.type,T,L&&L.is,L),G&8?u(R,f.children):G&16&&wt(f.children,R,null,w,v,T&&F!=="foreignObject",P,I),oe&&hn(f,null,w,"created"),L){for(const me in L)me!=="value"&&!Pi(me)&&r(R,me,null,L[me],T,f.children,w,v,S);"value"in L&&r(R,"value",null,L.value),(C=L.onVnodeBeforeMount)&&It(C,w,f)}vt(R,f,f.scopeId,P,w)}oe&&hn(f,null,w,"beforeMount");const ae=(!v||v&&!v.pendingBranch)&&j&&!j.persisted;ae&&j.beforeEnter(R),s(R,m,_),((C=L&&L.onVnodeMounted)||ae||oe)&&ze(()=>{C&&It(C,w,f),ae&&j.enter(R),oe&&hn(f,null,w,"mounted")},v)},vt=(f,m,_,w,v)=>{if(_&&g(f,_),w)for(let T=0;T<w.length;T++)g(f,w[T]);if(v){let T=v.subTree;if(m===T){const P=v.vnode;vt(f,P,P.scopeId,P.slotScopeIds,v.parent)}}},wt=(f,m,_,w,v,T,P,I,R=0)=>{for(let C=R;C<f.length;C++){const F=f[C]=I?Xt(f[C]):Tt(f[C]);k(null,F,m,_,w,v,T,P,I)}},jt=(f,m,_,w,v,T,P)=>{const I=m.el=f.el;let{patchFlag:R,dynamicChildren:C,dirs:F}=m;R|=f.patchFlag&16;const L=f.props||fe,G=m.props||fe;let j;_&&fn(_,!1),(j=G.onVnodeBeforeUpdate)&&It(j,_,m,f),F&&hn(m,f,_,"beforeUpdate"),_&&fn(_,!0);const ee=v&&m.type!=="foreignObject";if(C?Mt(f.dynamicChildren,C,I,_,w,ee,T):P||Ye(f,m,I,null,_,w,ee,T,!1),R>0){if(R&16)lt(I,m,L,G,_,w,v);else if(R&2&&L.class!==G.class&&r(I,"class",null,G.class,v),R&4&&r(I,"style",L.style,G.style,v),R&8){const oe=m.dynamicProps;for(let ae=0;ae<oe.length;ae++){const me=oe[ae],ct=L[me],Gn=G[me];(Gn!==ct||me==="value")&&r(I,me,ct,Gn,v,f.children,_,w,S)}}R&1&&f.children!==m.children&&u(I,m.children)}else!P&&C==null&&lt(I,m,L,G,_,w,v);((j=G.onVnodeUpdated)||F)&&ze(()=>{j&&It(j,_,m,f),F&&hn(m,f,_,"updated")},w)},Mt=(f,m,_,w,v,T,P)=>{for(let I=0;I<m.length;I++){const R=f[I],C=m[I],F=R.el&&(R.type===Bt||!ks(R,C)||R.shapeFlag&70)?d(R.el):_;k(R,C,F,null,w,v,T,P,!0)}},lt=(f,m,_,w,v,T,P)=>{if(_!==w){for(const I in w){if(Pi(I))continue;const R=w[I],C=_[I];R!==C&&I!=="value"&&r(f,I,C,R,P,m.children,v,T,S)}if(_!==fe)for(const I in _)!Pi(I)&&!(I in w)&&r(f,I,_[I],null,P,m.children,v,T,S);"value"in w&&r(f,"value",_.value,w.value)}},Ln=(f,m,_,w,v,T,P,I,R)=>{const C=m.el=f?f.el:a(""),F=m.anchor=f?f.anchor:a("");let{patchFlag:L,dynamicChildren:G,slotScopeIds:j}=m;j&&(I=I?I.concat(j):j),f==null?(s(C,_,w),s(F,_,w),wt(m.children,_,F,v,T,P,I,R)):L>0&&L&64&&G&&f.dynamicChildren?(Mt(f.dynamicChildren,G,_,v,T,P,I),(m.key!=null||v&&m===v.subTree)&&Gu(f,m,!0)):Ye(f,m,_,F,v,T,P,I,R)},Bn=(f,m,_,w,v,T,P,I,R)=>{m.slotScopeIds=I,f==null?m.shapeFlag&512?v.ctx.activate(m,_,w,P,R):Dn(m,_,w,v,T,P,R):ke(f,m,R)},Dn=(f,m,_,w,v,T,P)=>{const I=f.component=Vm(f,w,v);if(Tu(f)&&(I.ctx.renderer=de),zm(I),I.asyncDep){if(v&&v.registerDep(I,ue),!f.el){const R=I.subTree=Me(Tn);$(null,R,m,_)}return}ue(I,f,m,_,v,T,P)},ke=(f,m,_)=>{const w=m.component=f.component;if(im(f,m,_))if(w.asyncDep&&!w.asyncResolved){ie(w,m,_);return}else w.next=m,Jf(w.update),w.update();else m.el=f.el,w.vnode=m},ue=(f,m,_,w,v,T,P)=>{const I=()=>{if(f.isMounted){let{next:F,bu:L,u:G,parent:j,vnode:ee}=f,oe=F,ae;fn(f,!1),F?(F.el=ee.el,ie(f,F,P)):F=ee,L&&Pr(L),(ae=F.props&&F.props.onVnodeBeforeUpdate)&&It(ae,j,F,ee),fn(f,!0);const me=xr(f),ct=f.subTree;f.subTree=me,k(ct,me,d(ct.el),D(ct),f,v,T),F.el=me.el,oe===null&&rm(f,me.el),G&&ze(G,v),(ae=F.props&&F.props.onVnodeUpdated)&&ze(()=>It(ae,j,F,ee),v)}else{let F;const{el:L,props:G}=m,{bm:j,m:ee,parent:oe}=f,ae=Mi(m);if(fn(f,!1),j&&Pr(j),!ae&&(F=G&&G.onVnodeBeforeMount)&&It(F,oe,m),fn(f,!0),L&&V){const me=()=>{f.subTree=xr(f),V(L,f.subTree,f,v,null)};ae?m.type.__asyncLoader().then(()=>!f.isUnmounted&&me()):me()}else{const me=f.subTree=xr(f);k(null,me,_,w,f,v,T),m.el=me.el}if(ee&&ze(ee,v),!ae&&(F=G&&G.onVnodeMounted)){const me=m;ze(()=>It(F,oe,me),v)}(m.shapeFlag&256||oe&&Mi(oe.vnode)&&oe.vnode.shapeFlag&256)&&f.a&&ze(f.a,v),f.isMounted=!0,m=_=w=null}},R=f.effect=new zo(I,()=>gu(C),f.scope),C=f.update=()=>R.run();C.id=f.uid,fn(f,!0),C()},ie=(f,m,_)=>{m.component=f;const w=f.vnode.props;f.vnode=m,f.next=null,Pm(f,m.props,w,_),Mm(f,m.children,_),_s(),dr(void 0,f.update),ys()},Ye=(f,m,_,w,v,T,P,I,R=!1)=>{const C=f&&f.children,F=f?f.shapeFlag:0,L=m.children,{patchFlag:G,shapeFlag:j}=m;if(G>0){if(G&128){Ot(C,L,_,w,v,T,P,I,R);return}else if(G&256){Fn(C,L,_,w,v,T,P,I,R);return}}j&8?(F&16&&S(C,v,T),L!==C&&u(_,L)):F&16?j&16?Ot(C,L,_,w,v,T,P,I,R):S(C,v,T,!0):(F&8&&u(_,""),j&16&&wt(L,_,w,v,T,P,I,R))},Fn=(f,m,_,w,v,T,P,I,R)=>{f=f||Jn,m=m||Jn;const C=f.length,F=m.length,L=Math.min(C,F);let G;for(G=0;G<L;G++){const j=m[G]=R?Xt(m[G]):Tt(m[G]);k(f[G],j,_,null,v,T,P,I,R)}C>F?S(f,v,T,!0,!1,L):wt(m,_,w,v,T,P,I,R,L)},Ot=(f,m,_,w,v,T,P,I,R)=>{let C=0;const F=m.length;let L=f.length-1,G=F-1;for(;C<=L&&C<=G;){const j=f[C],ee=m[C]=R?Xt(m[C]):Tt(m[C]);if(ks(j,ee))k(j,ee,_,null,v,T,P,I,R);else break;C++}for(;C<=L&&C<=G;){const j=f[L],ee=m[G]=R?Xt(m[G]):Tt(m[G]);if(ks(j,ee))k(j,ee,_,null,v,T,P,I,R);else break;L--,G--}if(C>L){if(C<=G){const j=G+1,ee=j<F?m[j].el:w;for(;C<=G;)k(null,m[C]=R?Xt(m[C]):Tt(m[C]),_,ee,v,T,P,I,R),C++}}else if(C>G)for(;C<=L;)nt(f[C],v,T,!0),C++;else{const j=C,ee=C,oe=new Map;for(C=ee;C<=G;C++){const Xe=m[C]=R?Xt(m[C]):Tt(m[C]);Xe.key!=null&&oe.set(Xe.key,C)}let ae,me=0;const ct=G-ee+1;let Gn=!1,Ja=0;const Is=new Array(ct);for(C=0;C<ct;C++)Is[C]=0;for(C=j;C<=L;C++){const Xe=f[C];if(me>=ct){nt(Xe,v,T,!0);continue}let bt;if(Xe.key!=null)bt=oe.get(Xe.key);else for(ae=ee;ae<=G;ae++)if(Is[ae-ee]===0&&ks(Xe,m[ae])){bt=ae;break}bt===void 0?nt(Xe,v,T,!0):(Is[bt-ee]=C+1,bt>=Ja?Ja=bt:Gn=!0,k(Xe,m[bt],_,null,v,T,P,I,R),me++)}const Za=Gn?Fm(Is):Jn;for(ae=Za.length-1,C=ct-1;C>=0;C--){const Xe=ee+C,bt=m[Xe],el=Xe+1<F?m[Xe+1].el:w;Is[C]===0?k(null,bt,_,el,v,T,P,I,R):Gn&&(ae<0||C!==Za[ae]?Ct(bt,_,el,2):ae--)}}},Ct=(f,m,_,w,v=null)=>{const{el:T,type:P,transition:I,children:R,shapeFlag:C}=f;if(C&6){Ct(f.component.subTree,m,_,w);return}if(C&128){f.suspense.move(m,_,w);return}if(C&64){P.move(f,m,_,de);return}if(P===Bt){s(T,m,_);for(let L=0;L<R.length;L++)Ct(R[L],m,_,w);s(f.anchor,m,_);return}if(P===Oi){H(f,m,_);return}if(w!==2&&C&1&&I)if(w===0)I.beforeEnter(T),s(T,m,_),ze(()=>I.enter(T),v);else{const{leave:L,delayLeave:G,afterLeave:j}=I,ee=()=>s(T,m,_),oe=()=>{L(T,()=>{ee(),j&&j()})};G?G(T,ee,oe):oe()}else s(T,m,_)},nt=(f,m,_,w=!1,v=!1)=>{const{type:T,props:P,ref:I,children:R,dynamicChildren:C,shapeFlag:F,patchFlag:L,dirs:G}=f;if(I!=null&&uo(I,null,_,f,!0),F&256){m.ctx.deactivate(f);return}const j=F&1&&G,ee=!Mi(f);let oe;if(ee&&(oe=P&&P.onVnodeBeforeUnmount)&&It(oe,m,f),F&6)B(f.component,_,w);else{if(F&128){f.suspense.unmount(_,w);return}j&&hn(f,null,m,"beforeUnmount"),F&64?f.type.remove(f,m,_,v,de,w):C&&(T!==Bt||L>0&&L&64)?S(C,m,_,!1,!0):(T===Bt&&L&384||!v&&F&16)&&S(R,m,_),w&&bs(f)}(ee&&(oe=P&&P.onVnodeUnmounted)||j)&&ze(()=>{oe&&It(oe,m,f),j&&hn(f,null,m,"unmounted")},_)},bs=f=>{const{type:m,el:_,anchor:w,transition:v}=f;if(m===Bt){E(_,w);return}if(m===Oi){Ie(f);return}const T=()=>{i(_),v&&!v.persisted&&v.afterLeave&&v.afterLeave()};if(f.shapeFlag&1&&v&&!v.persisted){const{leave:P,delayLeave:I}=v,R=()=>P(_,T);I?I(f.el,T,R):R()}else T()},E=(f,m)=>{let _;for(;f!==m;)_=h(f),i(f),f=_;i(m)},B=(f,m,_)=>{const{bum:w,scope:v,update:T,subTree:P,um:I}=f;w&&Pr(w),v.stop(),T&&(T.active=!1,nt(P,f,m,_)),I&&ze(I,m),ze(()=>{f.isUnmounted=!0},m),m&&m.pendingBranch&&!m.isUnmounted&&f.asyncDep&&!f.asyncResolved&&f.suspenseId===m.pendingId&&(m.deps--,m.deps===0&&m.resolve())},S=(f,m,_,w=!1,v=!1,T=0)=>{for(let P=T;P<f.length;P++)nt(f[P],m,_,w,v)},D=f=>f.shapeFlag&6?D(f.component.subTree):f.shapeFlag&128?f.suspense.next():h(f.anchor||f.el),re=(f,m,_)=>{f==null?m._vnode&&nt(m._vnode,null,null,!0):k(m._vnode||null,f,m,null,null,null,_),Eu(),m._vnode=f},de={p:k,um:nt,m:Ct,r:bs,mt:Dn,mc:wt,pc:Ye,pbc:Mt,n:D,o:t};let J,V;return e&&([J,V]=e(de)),{render:re,hydrate:J,createApp:Lm(re,J)}}function fn({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function Gu(t,e,n=!1){const s=t.children,i=e.children;if(q(s)&&q(i))for(let r=0;r<s.length;r++){const o=s[r];let a=i[r];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=i[r]=Xt(i[r]),a.el=o.el),n||Gu(o,a))}}function Fm(t){const e=t.slice(),n=[0];let s,i,r,o,a;const l=t.length;for(s=0;s<l;s++){const c=t[s];if(c!==0){if(i=n[n.length-1],t[i]<c){e[s]=i,n.push(s);continue}for(r=0,o=n.length-1;r<o;)a=r+o>>1,t[n[a]]<c?r=a+1:o=a;c<t[n[r]]&&(r>0&&(e[s]=n[r-1]),n[r]=s)}}for(r=n.length,o=n[r-1];r-- >0;)n[r]=o,o=e[o];return n}const Gm=t=>t.__isTeleport,Bt=Symbol(void 0),ta=Symbol(void 0),Tn=Symbol(void 0),Oi=Symbol(void 0),Us=[];let ft=null;function mr(t=!1){Us.push(ft=t?null:[])}function $m(){Us.pop(),ft=Us[Us.length-1]||null}let Js=1;function yl(t){Js+=t}function $u(t){return t.dynamicChildren=Js>0?ft||Jn:null,$m(),Js>0&&ft&&ft.push(t),t}function Uu(t,e,n,s,i,r){return $u(Re(t,e,n,s,i,r,!0))}function Wu(t,e,n,s,i){return $u(Me(t,e,n,s,i,!0))}function ho(t){return t?t.__v_isVNode===!0:!1}function ks(t,e){return t.type===e.type&&t.key===e.key}const pr="__vInternal",Hu=({key:t})=>t!=null?t:null,Li=({ref:t,ref_key:e,ref_for:n})=>t!=null?Oe(t)||Ge(t)||Q(t)?{i:Rt,r:t,k:e,f:!!n}:t:null;function Re(t,e=null,n=null,s=0,i=null,r=t===Bt?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&Hu(e),ref:e&&Li(e),scopeId:Cu,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:s,dynamicProps:i,dynamicChildren:null,appContext:null};return a?(na(l,n),r&128&&t.normalize(l)):n&&(l.shapeFlag|=Oe(n)?8:16),Js>0&&!o&&ft&&(l.patchFlag>0||r&6)&&l.patchFlag!==32&&ft.push(l),l}const Me=Um;function Um(t,e=null,n=null,s=0,i=null,r=!1){if((!t||t===wm)&&(t=Tn),ho(t)){const a=is(t,e,!0);return n&&na(a,n),Js>0&&!r&&ft&&(a.shapeFlag&6?ft[ft.indexOf(t)]=a:ft.push(a)),a.patchFlag|=-2,a}if(Jm(t)&&(t=t.__vccOpts),e){e=Wm(e);let{class:a,style:l}=e;a&&!Oe(a)&&(e.class=Uo(a)),Pe(l)&&(lu(l)&&!q(l)&&(l=je({},l)),e.style=$o(l))}const o=Oe(t)?1:om(t)?128:Gm(t)?64:Pe(t)?4:Q(t)?2:0;return Re(t,e,n,s,i,o,r,!0)}function Wm(t){return t?lu(t)||pr in t?je({},t):t:null}function is(t,e,n=!1){const{props:s,ref:i,patchFlag:r,children:o}=t,a=e?Hm(s||{},e):s;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&Hu(a),ref:e&&e.ref?n&&i?q(i)?i.concat(Li(e)):[i,Li(e)]:Li(e):i,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Bt?r===-1?16:r|16:r,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&is(t.ssContent),ssFallback:t.ssFallback&&is(t.ssFallback),el:t.el,anchor:t.anchor}}function mi(t=" ",e=0){return Me(ta,null,t,e)}function ju(t,e){const n=Me(Oi,null,t);return n.staticCount=e,n}function XC(t="",e=!1){return e?(mr(),Wu(Tn,null,t)):Me(Tn,null,t)}function Tt(t){return t==null||typeof t=="boolean"?Me(Tn):q(t)?Me(Bt,null,t.slice()):typeof t=="object"?Xt(t):Me(ta,null,String(t))}function Xt(t){return t.el===null||t.memo?t:is(t)}function na(t,e){let n=0;const{shapeFlag:s}=t;if(e==null)e=null;else if(q(e))n=16;else if(typeof e=="object")if(s&65){const i=e.default;i&&(i._c&&(i._d=!1),na(t,i()),i._c&&(i._d=!0));return}else{n=32;const i=e._;!i&&!(pr in e)?e._ctx=Rt:i===3&&Rt&&(Rt.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else Q(e)?(e={default:e,_ctx:Rt},n=32):(e=String(e),s&64?(n=16,e=[mi(e)]):n=8);t.children=e,t.shapeFlag|=n}function Hm(...t){const e={};for(let n=0;n<t.length;n++){const s=t[n];for(const i in s)if(i==="class")e.class!==s.class&&(e.class=Uo([e.class,s.class]));else if(i==="style")e.style=$o([e.style,s.style]);else if(rr(i)){const r=e[i],o=s[i];o&&r!==o&&!(q(r)&&r.includes(o))&&(e[i]=r?[].concat(r,o):o)}else i!==""&&(e[i]=s[i])}return e}function It(t,e,n,s=null){gt(t,e,7,[n,s])}const jm=Fu();let qm=0;function Vm(t,e,n){const s=t.type,i=(e?e.appContext:t.appContext)||jm,r={uid:qm++,vnode:t,type:s,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,scope:new gf(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Ou(s,i),emitsOptions:wu(s,i),emit:null,emitted:null,propsDefaults:fe,inheritAttrs:s.inheritAttrs,ctx:fe,data:fe,props:fe,attrs:fe,slots:fe,refs:fe,setupState:fe,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=tm.bind(null,r),t.ce&&t.ce(r),r}let De=null;const rs=t=>{De=t,t.scope.on()},bn=()=>{De&&De.scope.off(),De=null};function qu(t){return t.vnode.shapeFlag&4}let Zs=!1;function zm(t,e=!1){Zs=e;const{props:n,children:s}=t.vnode,i=qu(t);Sm(t,n,i,e),Nm(t,s);const r=i?Qm(t,e):void 0;return Zs=!1,r}function Qm(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=cu(new Proxy(t.ctx,bm));const{setup:s}=n;if(s){const i=t.setupContext=s.length>1?Ym(t):null;rs(t),_s();const r=tn(s,t,0,[t.props,i]);if(ys(),bn(),Qc(r)){if(r.then(bn,bn),e)return r.then(o=>{El(t,o,e)}).catch(o=>{ur(o,t,0)});t.asyncDep=r}else El(t,r,e)}else Vu(t,e)}function El(t,e,n){Q(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:Pe(e)&&(t.setupState=fu(e)),Vu(t,n)}let vl;function Vu(t,e,n){const s=t.type;if(!t.render){if(!e&&vl&&!s.render){const i=s.template;if(i){const{isCustomElement:r,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:l}=s,c=je(je({isCustomElement:r,delimiters:a},o),l);s.render=vl(i,c)}}t.render=s.render||pt}rs(t),_s(),Im(t),ys(),bn()}function Km(t){return new Proxy(t.attrs,{get(e,n){return tt(t,"get","$attrs"),e[n]}})}function Ym(t){const e=s=>{t.exposed=s||{}};let n;return{get attrs(){return n||(n=Km(t))},slots:t.slots,emit:t.emit,expose:e}}function sa(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(fu(cu(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in $i)return $i[n](t)}}))}function Xm(t,e=!0){return Q(t)?t.displayName||t.name:t.name||e&&t.__name}function Jm(t){return Q(t)&&"__vccOpts"in t}const rt=(t,e)=>Kf(t,e,Zs);function zu(t,e,n){const s=arguments.length;return s===2?Pe(e)&&!q(e)?ho(e)?Me(t,null,[e]):Me(t,e):Me(t,null,e):(s>3?n=Array.prototype.slice.call(arguments,2):s===3&&ho(n)&&(n=[n]),Me(t,e,n))}const Zm="3.2.37",ep="http://www.w3.org/2000/svg",En=typeof document<"u"?document:null,wl=En&&En.createElement("template"),tp={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,s)=>{const i=e?En.createElementNS(ep,t):En.createElement(t,n?{is:n}:void 0);return t==="select"&&s&&s.multiple!=null&&i.setAttribute("multiple",s.multiple),i},createText:t=>En.createTextNode(t),createComment:t=>En.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>En.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},cloneNode(t){const e=t.cloneNode(!0);return"_value"in t&&(e._value=t._value),e},insertStaticContent(t,e,n,s,i,r){const o=n?n.previousSibling:e.lastChild;if(i&&(i===r||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),n),!(i===r||!(i=i.nextSibling)););else{wl.innerHTML=s?`<svg>${t}</svg>`:t;const a=wl.content;if(s){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function np(t,e,n){const s=t._vtc;s&&(e=(e?[e,...s]:[...s]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function sp(t,e,n){const s=t.style,i=Oe(n);if(n&&!i){for(const r in n)fo(s,r,n[r]);if(e&&!Oe(e))for(const r in e)n[r]==null&&fo(s,r,"")}else{const r=s.display;i?e!==n&&(s.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(s.display=r)}}const Cl=/\s*!important$/;function fo(t,e,n){if(q(n))n.forEach(s=>fo(t,e,s));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const s=ip(t,e);Cl.test(n)?t.setProperty(gs(s),n.replace(Cl,""),"important"):t[s]=n}}const bl=["Webkit","Moz","ms"],Nr={};function ip(t,e){const n=Nr[e];if(n)return n;let s=Pt(e);if(s!=="filter"&&s in t)return Nr[e]=s;s=lr(s);for(let i=0;i<bl.length;i++){const r=bl[i]+s;if(r in t)return Nr[e]=r}return e}const Il="http://www.w3.org/1999/xlink";function rp(t,e,n,s,i){if(s&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(Il,e.slice(6,e.length)):t.setAttributeNS(Il,e,n);else{const r=sf(e);n==null||r&&!qc(n)?t.removeAttribute(e):t.setAttribute(e,r?"":n)}}function op(t,e,n,s,i,r,o){if(e==="innerHTML"||e==="textContent"){s&&o(s,i,r),t[e]=n==null?"":n;return}if(e==="value"&&t.tagName!=="PROGRESS"&&!t.tagName.includes("-")){t._value=n;const l=n==null?"":n;(t.value!==l||t.tagName==="OPTION")&&(t.value=l),n==null&&t.removeAttribute(e);return}let a=!1;if(n===""||n==null){const l=typeof t[e];l==="boolean"?n=qc(n):n==null&&l==="string"?(n="",a=!0):l==="number"&&(n=0,a=!0)}try{t[e]=n}catch{}a&&t.removeAttribute(e)}const[Qu,ap]=(()=>{let t=Date.now,e=!1;if(typeof window<"u"){Date.now()>document.createEvent("Event").timeStamp&&(t=performance.now.bind(performance));const n=navigator.userAgent.match(/firefox\/(\d+)/i);e=!!(n&&Number(n[1])<=53)}return[t,e]})();let mo=0;const lp=Promise.resolve(),cp=()=>{mo=0},up=()=>mo||(lp.then(cp),mo=Qu());function dp(t,e,n,s){t.addEventListener(e,n,s)}function hp(t,e,n,s){t.removeEventListener(e,n,s)}function fp(t,e,n,s,i=null){const r=t._vei||(t._vei={}),o=r[e];if(s&&o)o.value=s;else{const[a,l]=mp(e);if(s){const c=r[e]=pp(s,i);dp(t,a,c,l)}else o&&(hp(t,a,o,l),r[e]=void 0)}}const kl=/(?:Once|Passive|Capture)$/;function mp(t){let e;if(kl.test(t)){e={};let n;for(;n=t.match(kl);)t=t.slice(0,t.length-n[0].length),e[n[0].toLowerCase()]=!0}return[gs(t.slice(2)),e]}function pp(t,e){const n=s=>{const i=s.timeStamp||Qu();(ap||i>=n.attached-1)&&gt(gp(s,n.value),e,5,[s])};return n.value=t,n.attached=up(),n}function gp(t,e){if(q(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(s=>i=>!i._stopped&&s&&s(i))}else return e}const Tl=/^on[a-z]/,_p=(t,e,n,s,i=!1,r,o,a,l)=>{e==="class"?np(t,s,i):e==="style"?sp(t,n,s):rr(e)?Wo(e)||fp(t,e,n,s,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):yp(t,e,s,i))?op(t,e,s,r,o,a,l):(e==="true-value"?t._trueValue=s:e==="false-value"&&(t._falseValue=s),rp(t,e,s,i))};function yp(t,e,n,s){return s?!!(e==="innerHTML"||e==="textContent"||e in t&&Tl.test(e)&&Q(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||Tl.test(e)&&Oe(n)?!1:e in t}const Ep=je({patchProp:_p},tp);let Al;function vp(){return Al||(Al=Bm(Ep))}const wp=(...t)=>{const e=vp().createApp(...t),{mount:n}=e;return e.mount=s=>{const i=Cp(s);if(!i)return;const r=e._component;!Q(r)&&!r.render&&!r.template&&(r.template=i.innerHTML),i.innerHTML="";const o=n(i,!1,i instanceof SVGElement);return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},e};function Cp(t){return Oe(t)?document.querySelector(t):t}const ia=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n},bp={};function Ip(t,e){const n=Pu("RouterView");return mr(),Wu(n)}const kp=ia(bp,[["render",Ip]]),Tp="modulepreload",Ap=function(t){return"/Quiz/"+t},Rl={},Ts=function(e,n,s){return!n||n.length===0?e():Promise.all(n.map(i=>{if(i=Ap(i),i in Rl)return;Rl[i]=!0;const r=i.endsWith(".css"),o=r?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${i}"]${o}`))return;const a=document.createElement("link");if(a.rel=r?"stylesheet":Tp,r||(a.as="script",a.crossOrigin=""),a.href=i,document.head.appendChild(a),r)return new Promise((l,c)=>{a.addEventListener("load",l),a.addEventListener("error",()=>c(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>e())};/*!
  * vue-router v4.1.2
  * (c) 2022 Eduardo San Martin Morote
  * @license MIT
  */const Kn=typeof window<"u";function Rp(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const Ee=Object.assign;function Mr(t,e){const n={};for(const s in e){const i=e[s];n[s]=yt(i)?i.map(t):t(i)}return n}const Ws=()=>{},yt=Array.isArray,Sp=/\/$/,Pp=t=>t.replace(Sp,"");function Or(t,e,n="/"){let s,i={},r="",o="";const a=e.indexOf("#");let l=e.indexOf("?");return a<l&&a>=0&&(l=-1),l>-1&&(s=e.slice(0,l),r=e.slice(l+1,a>-1?a:e.length),i=t(r)),a>-1&&(s=s||e.slice(0,a),o=e.slice(a,e.length)),s=Op(s!=null?s:e,n),{fullPath:s+(r&&"?")+r+o,path:s,query:i,hash:o}}function xp(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function Np(t,e,n){const s=e.matched.length-1,i=n.matched.length-1;return s>-1&&s===i&&os(e.matched[s],n.matched[i])&&Ku(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function os(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function Ku(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!Mp(t[n],e[n]))return!1;return!0}function Mp(t,e){return yt(t)?Sl(t,e):yt(e)?Sl(e,t):t===e}function Sl(t,e){return yt(e)?t.length===e.length&&t.every((n,s)=>n===e[s]):t.length===1&&t[0]===e}function Op(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),s=t.split("/");let i=n.length-1,r,o;for(r=0;r<s.length;r++)if(o=s[r],o!==".")if(o==="..")i>1&&i--;else break;return n.slice(0,i).join("/")+"/"+s.slice(r-(r===s.length?1:0)).join("/")}var ei;(function(t){t.pop="pop",t.push="push"})(ei||(ei={}));var Wi;(function(t){t.back="back",t.forward="forward",t.unknown=""})(Wi||(Wi={}));const Lr="";function Lp(t){if(!t)if(Kn){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),Pp(t)}const Bp=/^[^#]+#/;function Dp(t,e){return t.replace(Bp,"#")+e}function Fp(t,e){const n=document.documentElement.getBoundingClientRect(),s=t.getBoundingClientRect();return{behavior:e.behavior,left:s.left-n.left-(e.left||0),top:s.top-n.top-(e.top||0)}}const Gp=()=>({left:window.pageXOffset,top:window.pageYOffset});function $p(t){let e;if("el"in t){const n=t.el,s=typeof n=="string"&&n.startsWith("#"),i=typeof n=="string"?s?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!i)return;e=Fp(i,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function Pl(t,e){return(history.state?history.state.position-e:-1)+t}const po=new Map;function Up(t,e){po.set(t,e)}function Wp(t){const e=po.get(t);return po.delete(t),e}function Hp(t=""){let e=[],n=[Lr],s=0;t=Lp(t);function i(a){s++,s===n.length||n.splice(s),n.push(a)}function r(a,l,{direction:c,delta:u}){const d={direction:c,delta:u,type:ei.pop};for(const h of e)h(a,l,d)}const o={location:Lr,state:{},base:t,createHref:Dp.bind(null,t),replace(a){n.splice(s--,1),i(a)},push(a,l){i(a)},listen(a){return e.push(a),()=>{const l=e.indexOf(a);l>-1&&e.splice(l,1)}},destroy(){e=[],n=[Lr],s=0},go(a,l=!0){const c=this.location,u=a<0?Wi.back:Wi.forward;s=Math.max(0,Math.min(s+a,n.length-1)),l&&r(this.location,c,{direction:u,delta:a})}};return Object.defineProperty(o,"location",{enumerable:!0,get:()=>n[s]}),o}function jp(t){return typeof t=="string"||t&&typeof t=="object"}function Yu(t){return typeof t=="string"||typeof t=="symbol"}const Vt={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},Xu=Symbol("");var xl;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(xl||(xl={}));function as(t,e){return Ee(new Error,{type:t,[Xu]:!0},e)}function zt(t,e){return t instanceof Error&&Xu in t&&(e==null||!!(t.type&e))}const Nl="[^/]+?",qp={sensitive:!1,strict:!1,start:!0,end:!0},Vp=/[.+*?^${}()[\]/\\]/g;function zp(t,e){const n=Ee({},qp,e),s=[];let i=n.start?"^":"";const r=[];for(const c of t){const u=c.length?[]:[90];n.strict&&!c.length&&(i+="/");for(let d=0;d<c.length;d++){const h=c[d];let g=40+(n.sensitive?.25:0);if(h.type===0)d||(i+="/"),i+=h.value.replace(Vp,"\\$&"),g+=40;else if(h.type===1){const{value:y,repeatable:x,optional:k,regexp:N}=h;r.push({name:y,repeatable:x,optional:k});const $=N||Nl;if($!==Nl){g+=10;try{new RegExp(`(${$})`)}catch(H){throw new Error(`Invalid custom RegExp for param "${y}" (${$}): `+H.message)}}let W=x?`((?:${$})(?:/(?:${$}))*)`:`(${$})`;d||(W=k&&c.length<2?`(?:/${W})`:"/"+W),k&&(W+="?"),i+=W,g+=20,k&&(g+=-8),x&&(g+=-20),$===".*"&&(g+=-50)}u.push(g)}s.push(u)}if(n.strict&&n.end){const c=s.length-1;s[c][s[c].length-1]+=.7000000000000001}n.strict||(i+="/?"),n.end?i+="$":n.strict&&(i+="(?:/|$)");const o=new RegExp(i,n.sensitive?"":"i");function a(c){const u=c.match(o),d={};if(!u)return null;for(let h=1;h<u.length;h++){const g=u[h]||"",y=r[h-1];d[y.name]=g&&y.repeatable?g.split("/"):g}return d}function l(c){let u="",d=!1;for(const h of t){(!d||!u.endsWith("/"))&&(u+="/"),d=!1;for(const g of h)if(g.type===0)u+=g.value;else if(g.type===1){const{value:y,repeatable:x,optional:k}=g,N=y in c?c[y]:"";if(yt(N)&&!x)throw new Error(`Provided param "${y}" is an array but it is not repeatable (* or + modifiers)`);const $=yt(N)?N.join("/"):N;if(!$)if(k)h.length<2&&t.length>1&&(u.endsWith("/")?u=u.slice(0,-1):d=!0);else throw new Error(`Missing required param "${y}"`);u+=$}}return u}return{re:o,score:s,keys:r,parse:a,stringify:l}}function Qp(t,e){let n=0;for(;n<t.length&&n<e.length;){const s=e[n]-t[n];if(s)return s;n++}return t.length<e.length?t.length===1&&t[0]===40+40?-1:1:t.length>e.length?e.length===1&&e[0]===40+40?1:-1:0}function Kp(t,e){let n=0;const s=t.score,i=e.score;for(;n<s.length&&n<i.length;){const r=Qp(s[n],i[n]);if(r)return r;n++}if(Math.abs(i.length-s.length)===1){if(Ml(s))return 1;if(Ml(i))return-1}return i.length-s.length}function Ml(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const Yp={type:0,value:""},Xp=/[a-zA-Z0-9_]/;function Jp(t){if(!t)return[[]];if(t==="/")return[[Yp]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(g){throw new Error(`ERR (${n})/"${c}": ${g}`)}let n=0,s=n;const i=[];let r;function o(){r&&i.push(r),r=[]}let a=0,l,c="",u="";function d(){!c||(n===0?r.push({type:0,value:c}):n===1||n===2||n===3?(r.length>1&&(l==="*"||l==="+")&&e(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),r.push({type:1,value:c,regexp:u,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):e("Invalid state to consume buffer"),c="")}function h(){c+=l}for(;a<t.length;){if(l=t[a++],l==="\\"&&n!==2){s=n,n=4;continue}switch(n){case 0:l==="/"?(c&&d(),o()):l===":"?(d(),n=1):h();break;case 4:h(),n=s;break;case 1:l==="("?n=2:Xp.test(l)?h():(d(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--);break;case 2:l===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+l:n=3:u+=l;break;case 3:d(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--,u="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${c}"`),d(),o(),i}function Zp(t,e,n){const s=zp(Jp(t.path),n),i=Ee(s,{record:t,parent:e,children:[],alias:[]});return e&&!i.record.aliasOf==!e.record.aliasOf&&e.children.push(i),i}function eg(t,e){const n=[],s=new Map;e=Ll({strict:!1,end:!0,sensitive:!1},e);function i(u){return s.get(u)}function r(u,d,h){const g=!h,y=ng(u);y.aliasOf=h&&h.record;const x=Ll(e,u),k=[y];if("alias"in u){const W=typeof u.alias=="string"?[u.alias]:u.alias;for(const H of W)k.push(Ee({},y,{components:h?h.record.components:y.components,path:H,aliasOf:h?h.record:y}))}let N,$;for(const W of k){const{path:H}=W;if(d&&H[0]!=="/"){const Ie=d.record.path,Le=Ie[Ie.length-1]==="/"?"":"/";W.path=d.record.path+(H&&Le+H)}if(N=Zp(W,d,x),h?h.alias.push(N):($=$||N,$!==N&&$.alias.push(N),g&&u.name&&!Ol(N)&&o(u.name)),y.children){const Ie=y.children;for(let Le=0;Le<Ie.length;Le++)r(Ie[Le],N,h&&h.children[Le])}h=h||N,l(N)}return $?()=>{o($)}:Ws}function o(u){if(Yu(u)){const d=s.get(u);d&&(s.delete(u),n.splice(n.indexOf(d),1),d.children.forEach(o),d.alias.forEach(o))}else{const d=n.indexOf(u);d>-1&&(n.splice(d,1),u.record.name&&s.delete(u.record.name),u.children.forEach(o),u.alias.forEach(o))}}function a(){return n}function l(u){let d=0;for(;d<n.length&&Kp(u,n[d])>=0&&(u.record.path!==n[d].record.path||!Ju(u,n[d]));)d++;n.splice(d,0,u),u.record.name&&!Ol(u)&&s.set(u.record.name,u)}function c(u,d){let h,g={},y,x;if("name"in u&&u.name){if(h=s.get(u.name),!h)throw as(1,{location:u});x=h.record.name,g=Ee(tg(d.params,h.keys.filter($=>!$.optional).map($=>$.name)),u.params),y=h.stringify(g)}else if("path"in u)y=u.path,h=n.find($=>$.re.test(y)),h&&(g=h.parse(y),x=h.record.name);else{if(h=d.name?s.get(d.name):n.find($=>$.re.test(d.path)),!h)throw as(1,{location:u,currentLocation:d});x=h.record.name,g=Ee({},d.params,u.params),y=h.stringify(g)}const k=[];let N=h;for(;N;)k.unshift(N.record),N=N.parent;return{name:x,path:y,params:g,matched:k,meta:ig(k)}}return t.forEach(u=>r(u)),{addRoute:r,resolve:c,removeRoute:o,getRoutes:a,getRecordMatcher:i}}function tg(t,e){const n={};for(const s of e)s in t&&(n[s]=t[s]);return n}function ng(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:sg(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function sg(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const s in t.components)e[s]=typeof n=="boolean"?n:n[s];return e}function Ol(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function ig(t){return t.reduce((e,n)=>Ee(e,n.meta),{})}function Ll(t,e){const n={};for(const s in t)n[s]=s in e?e[s]:t[s];return n}function Ju(t,e){return e.children.some(n=>n===t||Ju(t,n))}const Zu=/#/g,rg=/&/g,og=/\//g,ag=/=/g,lg=/\?/g,ed=/\+/g,cg=/%5B/g,ug=/%5D/g,td=/%5E/g,dg=/%60/g,nd=/%7B/g,hg=/%7C/g,sd=/%7D/g,fg=/%20/g;function ra(t){return encodeURI(""+t).replace(hg,"|").replace(cg,"[").replace(ug,"]")}function mg(t){return ra(t).replace(nd,"{").replace(sd,"}").replace(td,"^")}function go(t){return ra(t).replace(ed,"%2B").replace(fg,"+").replace(Zu,"%23").replace(rg,"%26").replace(dg,"`").replace(nd,"{").replace(sd,"}").replace(td,"^")}function pg(t){return go(t).replace(ag,"%3D")}function gg(t){return ra(t).replace(Zu,"%23").replace(lg,"%3F")}function _g(t){return t==null?"":gg(t).replace(og,"%2F")}function Hi(t){try{return decodeURIComponent(""+t)}catch{}return""+t}function yg(t){const e={};if(t===""||t==="?")return e;const s=(t[0]==="?"?t.slice(1):t).split("&");for(let i=0;i<s.length;++i){const r=s[i].replace(ed," "),o=r.indexOf("="),a=Hi(o<0?r:r.slice(0,o)),l=o<0?null:Hi(r.slice(o+1));if(a in e){let c=e[a];yt(c)||(c=e[a]=[c]),c.push(l)}else e[a]=l}return e}function Bl(t){let e="";for(let n in t){const s=t[n];if(n=pg(n),s==null){s!==void 0&&(e+=(e.length?"&":"")+n);continue}(yt(s)?s.map(r=>r&&go(r)):[s&&go(s)]).forEach(r=>{r!==void 0&&(e+=(e.length?"&":"")+n,r!=null&&(e+="="+r))})}return e}function Eg(t){const e={};for(const n in t){const s=t[n];s!==void 0&&(e[n]=yt(s)?s.map(i=>i==null?null:""+i):s==null?s:""+s)}return e}const vg=Symbol(""),Dl=Symbol(""),oa=Symbol(""),id=Symbol(""),_o=Symbol("");function As(){let t=[];function e(s){return t.push(s),()=>{const i=t.indexOf(s);i>-1&&t.splice(i,1)}}function n(){t=[]}return{add:e,list:()=>t,reset:n}}function Jt(t,e,n,s,i){const r=s&&(s.enterCallbacks[i]=s.enterCallbacks[i]||[]);return()=>new Promise((o,a)=>{const l=d=>{d===!1?a(as(4,{from:n,to:e})):d instanceof Error?a(d):jp(d)?a(as(2,{from:e,to:d})):(r&&s.enterCallbacks[i]===r&&typeof d=="function"&&r.push(d),o())},c=t.call(s&&s.instances[i],e,n,l);let u=Promise.resolve(c);t.length<3&&(u=u.then(l)),u.catch(d=>a(d))})}function Br(t,e,n,s){const i=[];for(const r of t)for(const o in r.components){let a=r.components[o];if(!(e!=="beforeRouteEnter"&&!r.instances[o]))if(wg(a)){const c=(a.__vccOpts||a)[e];c&&i.push(Jt(c,n,s,r,o))}else{let l=a();i.push(()=>l.then(c=>{if(!c)return Promise.reject(new Error(`Couldn't resolve component "${o}" at "${r.path}"`));const u=Rp(c)?c.default:c;r.components[o]=u;const h=(u.__vccOpts||u)[e];return h&&Jt(h,n,s,r,o)()}))}}return i}function wg(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function Fl(t){const e=nn(oa),n=nn(id),s=rt(()=>e.resolve(ts(t.to))),i=rt(()=>{const{matched:l}=s.value,{length:c}=l,u=l[c-1],d=n.matched;if(!u||!d.length)return-1;const h=d.findIndex(os.bind(null,u));if(h>-1)return h;const g=Gl(l[c-2]);return c>1&&Gl(u)===g&&d[d.length-1].path!==g?d.findIndex(os.bind(null,l[c-2])):h}),r=rt(()=>i.value>-1&&kg(n.params,s.value.params)),o=rt(()=>i.value>-1&&i.value===n.matched.length-1&&Ku(n.params,s.value.params));function a(l={}){return Ig(l)?e[ts(t.replace)?"replace":"push"](ts(t.to)).catch(Ws):Promise.resolve()}return{route:s,href:rt(()=>s.value.href),isActive:r,isExactActive:o,navigate:a}}const Cg=ku({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:Fl,setup(t,{slots:e}){const n=fi(Fl(t)),{options:s}=nn(oa),i=rt(()=>({[$l(t.activeClass,s.linkActiveClass,"router-link-active")]:n.isActive,[$l(t.exactActiveClass,s.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const r=e.default&&e.default(n);return t.custom?r:zu("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:i.value},r)}}}),bg=Cg;function Ig(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function kg(t,e){for(const n in e){const s=e[n],i=t[n];if(typeof s=="string"){if(s!==i)return!1}else if(!yt(i)||i.length!==s.length||s.some((r,o)=>r!==i[o]))return!1}return!0}function Gl(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const $l=(t,e,n)=>t!=null?t:e!=null?e:n,Tg=ku({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const s=nn(_o),i=rt(()=>t.route||s.value),r=nn(Dl,0),o=rt(()=>{let c=ts(r);const{matched:u}=i.value;let d;for(;(d=u[c])&&!d.components;)c++;return c}),a=rt(()=>i.value.matched[o.value]);xi(Dl,rt(()=>o.value+1)),xi(vg,a),xi(_o,i);const l=jf();return Ni(()=>[l.value,a.value,t.name],([c,u,d],[h,g,y])=>{u&&(u.instances[d]=c,g&&g!==u&&c&&c===h&&(u.leaveGuards.size||(u.leaveGuards=g.leaveGuards),u.updateGuards.size||(u.updateGuards=g.updateGuards))),c&&u&&(!g||!os(u,g)||!h)&&(u.enterCallbacks[d]||[]).forEach(x=>x(c))},{flush:"post"}),()=>{const c=i.value,u=a.value,d=u&&u.components[t.name],h=t.name;if(!d)return Ul(n.default,{Component:d,route:c});const g=u.props[t.name],y=g?g===!0?c.params:typeof g=="function"?g(c):g:null,k=zu(d,Ee({},y,e,{onVnodeUnmounted:N=>{N.component.isUnmounted&&(u.instances[h]=null)},ref:l}));return Ul(n.default,{Component:k,route:c})||k}}});function Ul(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const Ag=Tg;function Rg(t){const e=eg(t.routes,t),n=t.parseQuery||yg,s=t.stringifyQuery||Bl,i=t.history,r=As(),o=As(),a=As(),l=qf(Vt);let c=Vt;Kn&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=Mr.bind(null,E=>""+E),d=Mr.bind(null,_g),h=Mr.bind(null,Hi);function g(E,B){let S,D;return Yu(E)?(S=e.getRecordMatcher(E),D=B):D=E,e.addRoute(D,S)}function y(E){const B=e.getRecordMatcher(E);B&&e.removeRoute(B)}function x(){return e.getRoutes().map(E=>E.record)}function k(E){return!!e.getRecordMatcher(E)}function N(E,B){if(B=Ee({},B||l.value),typeof E=="string"){const V=Or(n,E,B.path),f=e.resolve({path:V.path},B),m=i.createHref(V.fullPath);return Ee(V,f,{params:h(f.params),hash:Hi(V.hash),redirectedFrom:void 0,href:m})}let S;if("path"in E)S=Ee({},E,{path:Or(n,E.path,B.path).path});else{const V=Ee({},E.params);for(const f in V)V[f]==null&&delete V[f];S=Ee({},E,{params:d(E.params)}),B.params=d(B.params)}const D=e.resolve(S,B),re=E.hash||"";D.params=u(h(D.params));const de=xp(s,Ee({},E,{hash:mg(re),path:D.path})),J=i.createHref(de);return Ee({fullPath:de,hash:re,query:s===Bl?Eg(E.query):E.query||{}},D,{redirectedFrom:void 0,href:J})}function $(E){return typeof E=="string"?Or(n,E,l.value.path):Ee({},E)}function W(E,B){if(c!==E)return as(8,{from:B,to:E})}function H(E){return at(E)}function Ie(E){return H(Ee($(E),{replace:!0}))}function Le(E){const B=E.matched[E.matched.length-1];if(B&&B.redirect){const{redirect:S}=B;let D=typeof S=="function"?S(E):S;return typeof D=="string"&&(D=D.includes("?")||D.includes("#")?D=$(D):{path:D},D.params={}),Ee({query:E.query,hash:E.hash,params:"path"in D?{}:E.params},D)}}function at(E,B){const S=c=N(E),D=l.value,re=E.state,de=E.force,J=E.replace===!0,V=Le(S);if(V)return at(Ee($(V),{state:re,force:de,replace:J}),B||S);const f=S;f.redirectedFrom=B;let m;return!de&&Np(s,D,S)&&(m=as(16,{to:f,from:D}),Fn(D,D,!0,!1)),(m?Promise.resolve(m):wt(f,D)).catch(_=>zt(_)?zt(_,2)?_:Ye(_):ue(_,f,D)).then(_=>{if(_){if(zt(_,2))return at(Ee($(_.to),{state:re,force:de,replace:J}),B||f)}else _=Mt(f,D,!0,J,re);return jt(f,D,_),_})}function vt(E,B){const S=W(E,B);return S?Promise.reject(S):Promise.resolve()}function wt(E,B){let S;const[D,re,de]=Sg(E,B);S=Br(D.reverse(),"beforeRouteLeave",E,B);for(const V of D)V.leaveGuards.forEach(f=>{S.push(Jt(f,E,B))});const J=vt.bind(null,E,B);return S.push(J),$n(S).then(()=>{S=[];for(const V of r.list())S.push(Jt(V,E,B));return S.push(J),$n(S)}).then(()=>{S=Br(re,"beforeRouteUpdate",E,B);for(const V of re)V.updateGuards.forEach(f=>{S.push(Jt(f,E,B))});return S.push(J),$n(S)}).then(()=>{S=[];for(const V of E.matched)if(V.beforeEnter&&!B.matched.includes(V))if(yt(V.beforeEnter))for(const f of V.beforeEnter)S.push(Jt(f,E,B));else S.push(Jt(V.beforeEnter,E,B));return S.push(J),$n(S)}).then(()=>(E.matched.forEach(V=>V.enterCallbacks={}),S=Br(de,"beforeRouteEnter",E,B),S.push(J),$n(S))).then(()=>{S=[];for(const V of o.list())S.push(Jt(V,E,B));return S.push(J),$n(S)}).catch(V=>zt(V,8)?V:Promise.reject(V))}function jt(E,B,S){for(const D of a.list())D(E,B,S)}function Mt(E,B,S,D,re){const de=W(E,B);if(de)return de;const J=B===Vt,V=Kn?history.state:{};S&&(D||J?i.replace(E.fullPath,Ee({scroll:J&&V&&V.scroll},re)):i.push(E.fullPath,re)),l.value=E,Fn(E,B,S,J),Ye()}let lt;function Ln(){lt||(lt=i.listen((E,B,S)=>{if(!bs.listening)return;const D=N(E),re=Le(D);if(re){at(Ee(re,{replace:!0}),D).catch(Ws);return}c=D;const de=l.value;Kn&&Up(Pl(de.fullPath,S.delta),Gp()),wt(D,de).catch(J=>zt(J,12)?J:zt(J,2)?(at(J.to,D).then(V=>{zt(V,20)&&!S.delta&&S.type===ei.pop&&i.go(-1,!1)}).catch(Ws),Promise.reject()):(S.delta&&i.go(-S.delta,!1),ue(J,D,de))).then(J=>{J=J||Mt(D,de,!1),J&&(S.delta?i.go(-S.delta,!1):S.type===ei.pop&&zt(J,20)&&i.go(-1,!1)),jt(D,de,J)}).catch(Ws)}))}let Bn=As(),Dn=As(),ke;function ue(E,B,S){Ye(E);const D=Dn.list();return D.length?D.forEach(re=>re(E,B,S)):console.error(E),Promise.reject(E)}function ie(){return ke&&l.value!==Vt?Promise.resolve():new Promise((E,B)=>{Bn.add([E,B])})}function Ye(E){return ke||(ke=!E,Ln(),Bn.list().forEach(([B,S])=>E?S(E):B()),Bn.reset()),E}function Fn(E,B,S,D){const{scrollBehavior:re}=t;if(!Kn||!re)return Promise.resolve();const de=!S&&Wp(Pl(E.fullPath,0))||(D||!S)&&history.state&&history.state.scroll||null;return pu().then(()=>re(E,B,de)).then(J=>J&&$p(J)).catch(J=>ue(J,E,B))}const Ot=E=>i.go(E);let Ct;const nt=new Set,bs={currentRoute:l,listening:!0,addRoute:g,removeRoute:y,hasRoute:k,getRoutes:x,resolve:N,options:t,push:H,replace:Ie,go:Ot,back:()=>Ot(-1),forward:()=>Ot(1),beforeEach:r.add,beforeResolve:o.add,afterEach:a.add,onError:Dn.add,isReady:ie,install(E){const B=this;E.component("RouterLink",bg),E.component("RouterView",Ag),E.config.globalProperties.$router=B,Object.defineProperty(E.config.globalProperties,"$route",{enumerable:!0,get:()=>ts(l)}),Kn&&!Ct&&l.value===Vt&&(Ct=!0,H(i.location).catch(re=>{}));const S={};for(const re in Vt)S[re]=rt(()=>l.value[re]);E.provide(oa,B),E.provide(id,fi(S)),E.provide(_o,l);const D=E.unmount;nt.add(E),E.unmount=function(){nt.delete(E),nt.size<1&&(c=Vt,lt&&lt(),lt=null,l.value=Vt,Ct=!1,ke=!1),D()}}};return bs}function $n(t){return t.reduce((e,n)=>e.then(()=>n()),Promise.resolve())}function Sg(t,e){const n=[],s=[],i=[],r=Math.max(e.matched.length,t.matched.length);for(let o=0;o<r;o++){const a=e.matched[o];a&&(t.matched.find(c=>os(c,a))?s.push(a):n.push(a));const l=t.matched[o];l&&(e.matched.find(c=>os(c,l))||i.push(l))}return[n,s,i]}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mg(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function ud(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Mg())}function Og(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function dd(){return rd.NODE_ADMIN===!0}function Lg(){return typeof indexedDB=="object"}function Bg(){return new Promise((t,e)=>{try{let n=!0;const s="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(s);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(s),t(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var r;e(((r=i.error)===null||r===void 0?void 0:r.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fd=function(t){let e={},n={},s={},i="";try{const r=t.split(".");e=ti(Wl(r[0])||""),n=ti(Wl(r[1])||""),i=r[2],s=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:s,signature:i}},$g=function(t){const e=fd(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},Ug=function(t){const e=fd(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ca=new md("@firebase/app"),h_="@firebase/app-compat",f_="@firebase/analytics-compat",m_="@firebase/analytics",p_="@firebase/app-check-compat",g_="@firebase/app-check",__="@firebase/auth",y_="@firebase/auth-compat",E_="@firebase/database",v_="@firebase/database-compat",w_="@firebase/functions",C_="@firebase/functions-compat",b_="@firebase/installations",I_="@firebase/installations-compat",k_="@firebase/messaging",T_="@firebase/messaging-compat",A_="@firebase/performance",R_="@firebase/performance-compat",S_="@firebase/remote-config",P_="@firebase/remote-config-compat",x_="@firebase/storage",N_="@firebase/storage-compat",M_="@firebase/firestore",O_="@firebase/firestore-compat",L_="firebase",B_="9.9.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _d="[DEFAULT]",D_={[Co]:"fire-core",[h_]:"fire-core-compat",[m_]:"fire-analytics",[f_]:"fire-analytics-compat",[g_]:"fire-app-check",[p_]:"fire-app-check-compat",[__]:"fire-auth",[y_]:"fire-auth-compat",[E_]:"fire-rtdb",[v_]:"fire-rtdb-compat",[w_]:"fire-fn",[C_]:"fire-fn-compat",[b_]:"fire-iid",[I_]:"fire-iid-compat",[k_]:"fire-fcm",[T_]:"fire-fcm-compat",[A_]:"fire-perf",[R_]:"fire-perf-compat",[S_]:"fire-rc",[P_]:"fire-rc-compat",[x_]:"fire-gcs",[N_]:"fire-gcs-compat",[M_]:"fire-fst",[O_]:"fire-fst-compat","fire-js":"fire-js",[L_]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ed=B_;function U_(t,e={}){typeof e!="object"&&(e={name:e});const n=Object.assign({name:_d,automaticDataCollectionEnabled:!1},e),s=n.name;if(typeof s!="string"||!s)throw An.create("bad-app-name",{appName:String(s)});const i=qi.get(s);if(i){if(Eo(t,i.options)&&Eo(n,i.config))return i;throw An.create("duplicate-app",{appName:s})}const r=new Qg(s);for(const a of bo.values())r.addComponent(a);const o=new $_(t,n,r);return qi.set(s,o),o}function vd(t=_d){const e=qi.get(t);if(!e)throw An.create("no-app",{appName:t});return e}function rn(t,e,n){var s;let i=(s=D_[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ca.warn(a.join(" "));return}ni(new us(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const W_="firebase-heartbeat-database",H_=1,si="firebase-heartbeat-store";let $r=null;function wd(){return $r||($r=a_(W_,H_,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(si)}}}).catch(t=>{throw An.create("storage-open",{originalErrorMessage:t.message})})),$r}async function j_(t){var e;try{return(await wd()).transaction(si).objectStore(si).get(Cd(t))}catch(n){throw An.create("storage-get",{originalErrorMessage:(e=n)===null||e===void 0?void 0:e.message})}}async function Ql(t,e){var n;try{const i=(await wd()).transaction(si,"readwrite");return await i.objectStore(si).put(e,Cd(t)),i.done}catch(s){throw An.create("storage-set",{originalErrorMessage:(n=s)===null||n===void 0?void 0:n.message})}}function Cd(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ns=new md("@firebase/database"),ny=function(){let t=1;return function(){return t++}}(),kd=function(t){const e=jg(t),n=new Hg;n.update(e);const s=n.digest();return aa.encodeByteArray(s)},pi=function(...t){let e="";for(let n=0;n<t.length;n++){const s=t[n];Array.isArray(s)||s&&typeof s=="object"&&typeof s.length=="number"?e+=pi.apply(null,s):typeof s=="object"?e+=Se(s):e+=s,e+=" "}return e};let In=null,Zl=!0;const sy=function(t,e){b(!e||t===!0||t===!1,"Can't turn on custom loggers persistently."),t===!0?(ns.logLevel=he.VERBOSE,In=ns.log.bind(ns),e&&Io.set("logging_enabled",!0)):typeof t=="function"?In=t:(In=null,Io.remove("logging_enabled"))},Be=function(...t){if(Zl===!0&&(Zl=!1,In===null&&Io.get("logging_enabled")===!0&&sy(!0)),In){const e=pi.apply(null,t);In(e)}},gi=function(t){return function(...e){Be(t,...e)}},ko=function(...t){const e="FIREBASE INTERNAL ERROR: "+pi(...t);ns.error(e)},Rn=function(...t){const e=`FIREBASE FATAL ERROR: ${pi(...t)}`;throw ns.error(e),new Error(e)},Ke=function(...t){const e="FIREBASE WARNING: "+pi(...t);ns.warn(e)},iy=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&Ke("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},yr=function(t){return typeof t=="number"&&(t!==t||t===Number.POSITIVE_INFINITY||t===Number.NEGATIVE_INFINITY)},ry=function(t){if(document.readyState==="complete")t();else{let e=!1;const n=function(){if(!document.body){setTimeout(n,Math.floor(10));return}e||(e=!0,t())};document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&n()}),window.attachEvent("onload",n))}},ds="[MIN_NAME]",Sn="[MAX_NAME]",Mn=function(t,e){if(t===e)return 0;if(t===ds||e===Sn)return-1;if(e===ds||t===Sn)return 1;{const n=ec(t),s=ec(e);return n!==null?s!==null?n-s===0?t.length-e.length:n-s:-1:s!==null?1:t<e?-1:1}},oy=function(t,e){return t===e?0:t<e?-1:1},Rs=function(t,e){if(e&&t in e)return e[t];throw new Error("Missing required key ("+t+") in object: "+Se(e))},ua=function(t){if(typeof t!="object"||t===null)return Se(t);const e=[];for(const s in t)e.push(s);e.sort();let n="{";for(let s=0;s<e.length;s++)s!==0&&(n+=","),n+=Se(e[s]),n+=":",n+=ua(t[e[s]]);return n+="}",n},Td=function(t,e){const n=t.length;if(n<=e)return[t];const s=[];for(let i=0;i<n;i+=e)i+e>n?s.push(t.substring(i,n)):s.push(t.substring(i,i+e));return s};function $e(t,e){for(const n in t)t.hasOwnProperty(n)&&e(n,t[n])}const Ad=function(t){b(!yr(t),"Invalid JSON number");const e=11,n=52,s=(1<<e-1)-1;let i,r,o,a,l;t===0?(r=0,o=0,i=1/t===-1/0?1:0):(i=t<0,t=Math.abs(t),t>=Math.pow(2,1-s)?(a=Math.min(Math.floor(Math.log(t)/Math.LN2),s),r=a+s,o=Math.round(t*Math.pow(2,n-a)-Math.pow(2,n))):(r=0,o=Math.round(t/Math.pow(2,1-s-n))));const c=[];for(l=n;l;l-=1)c.push(o%2?1:0),o=Math.floor(o/2);for(l=e;l;l-=1)c.push(r%2?1:0),r=Math.floor(r/2);c.push(i?1:0),c.reverse();const u=c.join("");let d="";for(l=0;l<64;l+=8){let h=parseInt(u.substr(l,8),2).toString(16);h.length===1&&(h="0"+h),d=d+h}return d.toLowerCase()},ay=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},ly=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function cy(t,e){let n="Unknown Error";t==="too_big"?n="The data requested exceeds the maximum size that can be accessed with a single request.":t==="permission_denied"?n="Client doesn't have permission to access the desired data.":t==="unavailable"&&(n="The service is unavailable");const s=new Error(t+" at "+e._path.toString()+": "+n);return s.code=t.toUpperCase(),s}const uy=new RegExp("^-?(0*)\\d{1,10}$"),dy=-2147483648,hy=2147483647,ec=function(t){if(uy.test(t)){const e=Number(t);if(e>=dy&&e<=hy)return e}return null},vs=function(t){try{t()}catch(e){setTimeout(()=>{const n=e.stack||"";throw Ke("Exception was thrown by user callback.",n),e},Math.floor(0))}},fy=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},Hs=function(t,e){const n=setTimeout(t,e);return typeof n=="object"&&n.unref&&n.unref(),n};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class py{constructor(e,n,s){this.appName_=e,this.firebaseOptions_=n,this.authProvider_=s,this.auth_=null,this.auth_=s.getImmediate({optional:!0}),this.auth_||s.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(n=>n&&n.code==="auth/token-not-initialized"?(Be("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(n)):new Promise((n,s)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(n,s):n(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(n=>n.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(n=>n.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',Ke(e)}}class To{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}To.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const da="5",Rd="v",Sd="s",Pd="r",xd="f",Nd=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Md="ls",Od="p",Ao="ac",Ld="websocket",Bd="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ur={},Wr={};function ha(t){const e=t.toString();return Ur[e]||(Ur[e]=new yy),Ur[e]}function Ey(t,e){const n=t.toString();return Wr[n]||(Wr[n]=e()),Wr[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tc="start",wy="close",Cy="pLPCommand",by="pRTLPCB",Fd="id",Gd="pw",$d="ser",Iy="cb",ky="seg",Ty="ts",Ay="d",Ry="dframe",Ud=1870,Wd=30,Sy=Ud-Wd,Py=25e3,xy=3e4;class Xn{constructor(e,n,s,i,r,o,a){this.connId=e,this.repoInfo=n,this.applicationId=s,this.appCheckToken=i,this.authToken=r,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=gi(e),this.stats_=ha(n),this.urlFn=l=>(this.appCheckToken&&(l[Ao]=this.appCheckToken),Dd(n,Bd,l))}open(e,n){this.curSegmentNum=0,this.onDisconnect_=n,this.myPacketOrderer=new vy(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(xy)),ry(()=>{if(this.isClosed_)return;this.scriptTagHolder=new fa((...r)=>{const[o,a,l,c,u]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===tc)this.id=a,this.password=l;else if(o===wy)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,a]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const s={};s[tc]="t",s[$d]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(s[Iy]=this.scriptTagHolder.uniqueCallbackIdentifier),s[Rd]=da,this.transportSessionId&&(s[Sd]=this.transportSessionId),this.lastSessionId&&(s[Md]=this.lastSessionId),this.applicationId&&(s[Od]=this.applicationId),this.appCheckToken&&(s[Ao]=this.appCheckToken),typeof location<"u"&&location.hostname&&Nd.test(location.hostname)&&(s[Pd]=xd);const i=this.urlFn(s);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){Xn.forceAllow_=!0}static forceDisallow(){Xn.forceDisallow_=!0}static isAvailable(){return Xn.forceAllow_?!0:!Xn.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!ay()&&!ly()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const n=Se(e);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const s=ad(n),i=Td(s,Sy);for(let r=0;r<i.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[r]),this.curSegmentNum++}addDisconnectPingFrame(e,n){this.myDisconnFrame=document.createElement("iframe");const s={};s[Ry]="t",s[Fd]=e,s[Gd]=n,this.myDisconnFrame.src=this.urlFn(s),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const n=Se(e).length;this.bytesReceived+=n,this.stats_.incrementCounter("bytes_received",n)}}class fa{constructor(e,n,s,i){this.onDisconnect=s,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=ny(),window[Cy+this.uniqueCallbackIdentifier]=e,window[by+this.uniqueCallbackIdentifier]=n,this.myIFrame=fa.createIFrame_();let r="";if(this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"){const a=document.domain;r='<script>document.domain="'+a+'";<\/script>'}const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){Be("frame writing exception"),a.stack&&Be(a.stack),Be(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||Be("No IE domain setting required")}catch{const s=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+s+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.innerHTML="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,n){for(this.myID=e,this.myPW=n,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[Fd]=this.myID,e[Gd]=this.myPW,e[$d]=this.currentSerial;let n=this.urlFn(e),s="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Wd+s.length<=Ud;){const o=this.pendingSegs.shift();s=s+"&"+ky+i+"="+o.seg+"&"+Ty+i+"="+o.ts+"&"+Ay+i+"="+o.d,i++}return n=n+s,this.addLongPollTag_(n,this.currentSerial),!0}else return!1}enqueueSegment(e,n,s){this.pendingSegs.push({seg:e,ts:n,d:s}),this.alive&&this.newRequest_()}addLongPollTag_(e,n){this.outstandingRequests.add(n);const s=()=>{this.outstandingRequests.delete(n),this.newRequest_()},i=setTimeout(s,Math.floor(Py)),r=()=>{clearTimeout(i),s()};this.addTag(e,r)}addTag(e,n){setTimeout(()=>{try{if(!this.sendNewPolls)return;const s=this.myIFrame.doc.createElement("script");s.type="text/javascript",s.async=!0,s.src=e,s.onload=s.onreadystatechange=function(){const i=s.readyState;(!i||i==="loaded"||i==="complete")&&(s.onload=s.onreadystatechange=null,s.parentNode&&s.parentNode.removeChild(s),n())},s.onerror=()=>{Be("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(s)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jy(t,e){return Mn(t.name,e.name)}function _a(t,e){return Mn(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ro;function Zy(t){Ro=t}const Qd=function(t){return typeof t=="number"?"number:"+Ad(t):"string:"+t},Kd=function(t){if(t.isLeafNode()){const e=t.val();b(typeof e=="string"||typeof e=="number"||typeof e=="object"&&xt(e,".sv"),"Priority must be a string or number.")}else b(t===Ro||t.isEmpty(),"priority of unexpected type.");b(t===Ro||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Yd,Xd;function eE(t){Yd=t}function tE(t){Xd=t}class nE extends Er{compare(e,n){const s=e.node.getPriority(),i=n.node.getPriority(),r=s.compareTo(i);return r===0?Mn(e.name,n.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return X.MIN}maxPost(){return new X(Sn,new xe("[PRIORITY-POST]",Xd))}makePost(e,n){const s=Yd(e);return new X(n,new xe("[PRIORITY-POST]",s))}toString(){return".priority"}}const _e=new nE;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lE extends Er{compare(e,n){const s=e.node.compareTo(n.node);return s===0?Mn(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return X.MIN}maxPost(){return X.MAX}makePost(e,n){const s=ve(e);return new X(n,s)}toString(){return".value"}}const cE=new lE;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yi(){return{value:null,children:new Map}}function ws(t,e,n){if(Y(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const s=K(e);t.children.has(s)||t.children.set(s,Yi());const i=t.children.get(s);e=ce(e),ws(i,e,n)}}function So(t,e){if(Y(e))return t.value=null,t.children.clear(),!0;if(t.value!==null){if(t.value.isLeafNode())return!1;{const n=t.value;return t.value=null,n.forEachChild(_e,(s,i)=>{ws(t,new se(s),i)}),So(t,e)}}else if(t.children.size>0){const n=K(e);return e=ce(e),t.children.has(n)&&So(t.children.get(n),e)&&t.children.delete(n),t.children.size===0}else return!0}function Po(t,e,n){t.value!==null?n(e,t.value):mE(t,(s,i)=>{const r=new se(e.toString()+"/"+s);Po(i,r,n)})}function mE(t,e){t.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pc=10*1e3,gE=30*1e3,_E=5*60*1e3;class yE{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new pE(e);const s=pc+(gE-pc)*Math.random();Hs(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;$e(e,(i,r)=>{r>0&&xt(this.statsToReport_,i)&&(n[i]=r,s=!0)}),s&&this.server_.reportStats(n),Hs(this.reportStats_.bind(this),Math.floor(Math.random()*2*_E))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wr(t,e){return rh(e,t)}function IE(t,e,n,s,i){b(s>t.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),t.allWrites.push({path:e,snap:n,writeId:s,visible:i}),i&&(t.visibleWrites=qs(t.visibleWrites,e,n)),t.lastWriteId=s}function kE(t,e){for(let n=0;n<t.allWrites.length;n++){const s=t.allWrites[n];if(s.writeId===e)return s}return null}function TE(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);b(n>=0,"removeWrite called with nonexistent writeId.");const s=t.allWrites[n];t.allWrites.splice(n,1);let i=s.visible,r=!1,o=t.allWrites.length-1;for(;i&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&AE(a,s.path)?i=!1:ot(s.path,a.path)&&(r=!0)),o--}if(i){if(r)return RE(t),!0;if(s.snap)t.visibleWrites=_c(t.visibleWrites,s.path);else{const a=s.children;$e(a,l=>{t.visibleWrites=_c(t.visibleWrites,we(s.path,l))})}return!0}else return!1}function AE(t,e){if(t.snap)return ot(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&ot(we(t.path,n),e))return!0;return!1}function RE(t){t.visibleWrites=nh(t.allWrites,SE,te()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function SE(t){return t.visible}function nh(t,e,n){let s=_t.empty();for(let i=0;i<t.length;++i){const r=t[i];if(e(r)){const o=r.path;let a;if(r.snap)ot(n,o)?(a=He(n,o),s=qs(s,a,r.snap)):ot(o,n)&&(a=He(o,n),s=qs(s,te(),r.snap.getChild(a)));else if(r.children){if(ot(n,o))a=He(n,o),s=gc(s,a,r.children);else if(ot(o,n))if(a=He(o,n),Y(a))s=gc(s,te(),r.children);else{const l=ls(r.children,K(a));if(l){const c=l.getChild(ce(a));s=qs(s,te(),c)}}}else throw Es("WriteRecord should have .snap or .children")}}return s}function sh(t,e,n,s,i){if(!s&&!i){const r=On(t.visibleWrites,e);if(r!=null)return r;{const o=on(t.visibleWrites,e);if(No(o))return n;if(n==null&&!xo(o,te()))return null;{const a=n||U.EMPTY_NODE;return fs(o,a)}}}else{const r=on(t.visibleWrites,e);if(!i&&No(r))return n;if(!i&&n==null&&!xo(r,te()))return null;{const o=function(c){return(c.visible||i)&&(!s||!~s.indexOf(c.writeId))&&(ot(c.path,e)||ot(e,c.path))},a=nh(t.allWrites,o,e),l=n||U.EMPTY_NODE;return fs(a,l)}}}function PE(t,e,n){let s=U.EMPTY_NODE;const i=On(t.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(_e,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(n){const r=on(t.visibleWrites,e);return n.forEachChild(_e,(o,a)=>{const l=fs(on(r,new se(o)),a);s=s.updateImmediateChild(o,l)}),yc(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=on(t.visibleWrites,e);return yc(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function xE(t,e,n,s,i){b(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=we(e,n);if(xo(t.visibleWrites,r))return null;{const o=on(t.visibleWrites,r);return No(o)?i.getChild(n):fs(o,i.getChild(n))}}function NE(t,e,n,s){const i=we(e,n),r=On(t.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(n)){const o=on(t.visibleWrites,i);return fs(o,s.getNode().getImmediateChild(n))}else return null}function ME(t,e){return On(t.visibleWrites,e)}function OE(t,e,n,s,i,r,o){let a;const l=on(t.visibleWrites,e),c=On(l,te());if(c!=null)a=c;else if(n!=null)a=fs(l,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],d=o.getCompare(),h=r?a.getReverseIteratorFrom(s,o):a.getIteratorFrom(s,o);let g=h.getNext();for(;g&&u.length<i;)d(g,s)!==0&&u.push(g),g=h.getNext();return u}else return[]}function LE(){return{visibleWrites:_t.empty(),allWrites:[],lastWriteId:-1}}function Zi(t,e,n,s){return sh(t.writeTree,t.treePath,e,n,s)}function Ca(t,e){return PE(t.writeTree,t.treePath,e)}function Ec(t,e,n,s){return xE(t.writeTree,t.treePath,e,n,s)}function er(t,e){return ME(t.writeTree,we(t.treePath,e))}function BE(t,e,n,s,i,r){return OE(t.writeTree,t.treePath,e,n,s,i,r)}function ba(t,e,n){return NE(t.writeTree,t.treePath,e,n)}function ih(t,e){return rh(we(t.treePath,e),t.writeTree)}function rh(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class FE{getCompleteChild(e){return null}getChildAfterChild(e,n,s){return null}}const oh=new FE;class Ia{constructor(e,n,s=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=s}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new un(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return ba(this.writes_,e,s)}}getChildAfterChild(e,n,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:xn(this.viewCache_),r=BE(this.writes_,i,n,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xa{constructor(e){this.node_=e}getImmediateChild(e){const n=this.node_.getImmediateChild(e);return new xa(n)}node(){return this.node_}}class Na{constructor(e,n){this.syncTree_=e,this.path_=n}getImmediateChild(e){const n=we(this.path_,e);return new Na(this.syncTree_,n)}node(){return Aa(this.syncTree_,this.path_)}}const _v=function(t){return t=t||{},t.timestamp=t.timestamp||new Date().getTime(),t},Ac=function(t,e,n){if(!t||typeof t!="object")return t;if(b(".sv"in t,"Unexpected leaf node or priority contents"),typeof t[".sv"]=="string")return yv(t[".sv"],e,n);if(typeof t[".sv"]=="object")return Ev(t[".sv"],e);b(!1,"Unexpected server value: "+JSON.stringify(t,null,2))},yv=function(t,e,n){switch(t){case"timestamp":return n.timestamp;default:b(!1,"Unexpected server value: "+t)}},Ev=function(t,e,n){t.hasOwnProperty("increment")||b(!1,"Unexpected server value: "+JSON.stringify(t,null,2));const s=t.increment;typeof s!="number"&&b(!1,"Unexpected increment value: "+s);const i=e.node();if(b(i!==null&&typeof i<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return s;const o=i.getValue();return typeof o!="number"?s:o+s},vv=function(t,e,n,s){return Ma(e,new Na(n,t),s)},Eh=function(t,e,n){return Ma(t,new xa(e),n)};function Ma(t,e,n){const s=t.getPriority().val(),i=Ac(s,e.getImmediateChild(".priority"),n);let r;if(t.isLeafNode()){const o=t,a=Ac(o.getValue(),e,n);return a!==o.getValue()||i!==o.getPriority().val()?new xe(a,ve(i)):t}else{const o=t;return r=o,i!==o.getPriority().val()&&(r=r.updatePriority(new xe(i))),o.forEachChild(_e,(a,l)=>{const c=Ma(l,e.getImmediateChild(a),n);c!==l&&(r=r.updateImmediateChild(a,c))}),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oa{constructor(e="",n=null,s={children:{},childCount:0}){this.name=e,this.parent=n,this.node=s}}function La(t,e){let n=e instanceof se?e:new se(e),s=t,i=K(n);for(;i!==null;){const r=ls(s.node.children,i)||{children:{},childCount:0};s=new Oa(i,s,r),n=ce(n),i=K(n)}return s}function Cs(t){return t.node.value}function vh(t,e){t.node.value=e,Lo(t)}function wh(t){return t.node.childCount>0}function wv(t){return Cs(t)===void 0&&!wh(t)}function Ir(t,e){$e(t.node.children,(n,s)=>{e(new Oa(n,t,s))})}function Ch(t,e,n,s){n&&!s&&e(t),Ir(t,i=>{Ch(i,e,!0,s)}),n&&s&&e(t)}function Cv(t,e,n){let s=n?t:t.parent;for(;s!==null;){if(e(s))return!0;s=s.parent}return!1}function vi(t){return new se(t.parent===null?t.name:vi(t.parent)+"/"+t.name)}function Lo(t){t.parent!==null&&bv(t.parent,t.name,t)}function bv(t,e,n){const s=wv(n),i=xt(t.node.children,e);s&&i?(delete t.node.children[e],t.node.childCount--,Lo(t)):!s&&!i&&(t.node.children[e]=n.node,t.node.childCount++,Lo(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nv{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Da(t,e){let n=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();n!==null&&!pa(r,n.path)&&(t.eventLists_.push(n),n=null),n===null&&(n={events:[],path:r}),n.events.push(i)}n&&t.eventLists_.push(n)}function Th(t,e,n){Da(t,n),Ah(t,s=>pa(s,e))}function Wt(t,e,n){Da(t,n),Ah(t,s=>ot(s,e)||ot(e,s))}function Ah(t,e){t.recursionDepth_++;let n=!0;for(let s=0;s<t.eventLists_.length;s++){const i=t.eventLists_[s];if(i){const r=i.path;e(r)?(Mv(t.eventLists_[s]),t.eventLists_[s]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function Mv(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(n!==null){t.events[e]=null;const s=n.getEventRunner();In&&Be("event: "+n.toString()),vs(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ov="repo_interrupt",Lv=25;class Bv{constructor(e,n,s,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Nv,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Yi(),this.transactionQueueTree_=new Oa,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Dv(t,e,n){if(t.stats_=ha(t.repoInfo_),t.forceRestClient_||fy())t.server_=new Ki(t.repoInfo_,(s,i,r,o)=>{Rc(t,s,i,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Sc(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Se(n)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}t.persistentConnection_=new $t(t.repoInfo_,e,(s,i,r,o)=>{Rc(t,s,i,r,o)},s=>{Sc(t,s)},s=>{Gv(t,s)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(s=>{t.server_.refreshAuthToken(s)}),t.appCheckProvider_.addTokenChangeListener(s=>{t.server_.refreshAppCheckToken(s.token)}),t.statsReporter_=Ey(t.repoInfo_,()=>new yE(t.stats_,t.server_)),t.infoData_=new fE,t.infoSyncTree_=new kc({startListening:(s,i,r,o)=>{let a=[];const l=t.infoData_.getNode(s._path);return l.isEmpty()||(a=yi(t.infoSyncTree_,s._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Ga(t,"connected",!1),t.serverSyncTree_=new kc({startListening:(s,i,r,o)=>(t.server_.listen(s,r,i,(a,l)=>{const c=o(a,l);Wt(t.eventQueue_,s._path,c)}),[]),stopListening:(s,i)=>{t.server_.unlisten(s,i)}})}function Fv(t){const n=t.infoData_.getNode(new se(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Fa(t){return _v({timestamp:Fv(t)})}function Rc(t,e,n,s,i){t.dataUpdateCount++;const r=new se(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(s){const l=ji(n,c=>ve(c));o=dv(t.serverSyncTree_,r,l,i)}else{const l=ve(n);o=mh(t.serverSyncTree_,r,l,i)}else if(s){const l=ji(n,c=>ve(c));o=av(t.serverSyncTree_,r,l)}else{const l=ve(n);o=yi(t.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=Tr(t,r)),Wt(t.eventQueue_,a,o)}function Sc(t,e){Ga(t,"connected",e),e===!1&&Wv(t)}function Gv(t,e){$e(e,(n,s)=>{Ga(t,n,s)})}function Ga(t,e,n){const s=new se("/.info/"+e),i=ve(n);t.infoData_.updateSnapshot(s,i);const r=yi(t.infoSyncTree_,s,i);Wt(t.eventQueue_,s,r)}function Rh(t){return t.nextWriteId_++}function $v(t,e){const n=hv(t.serverSyncTree_,e);return n!=null?Promise.resolve(n):t.server_.get(e).then(s=>{const i=ve(s).withIndex(e._queryParams.getIndex());if(e._queryParams.loadsAllData())yi(t.serverSyncTree_,e._path,i);else{const o=uv(t.serverSyncTree_,e);mh(t.serverSyncTree_,e._path,i,o)}return ir(t.serverSyncTree_,e,null).length>0&&hi(t,"unexpected cancel events in repoGetValue"),i},s=>(hi(t,"get for query "+Se(e)+" failed: "+s),Promise.reject(new Error(s))))}function Uv(t,e,n,s,i){hi(t,"set",{path:e.toString(),value:n,priority:s});const r=Fa(t),o=ve(n,s),a=Aa(t.serverSyncTree_,e),l=Eh(o,a,r),c=Rh(t),u=fh(t.serverSyncTree_,e,l,c,!0);Da(t.eventQueue_,u),t.server_.put(e.toString(),o.val(!0),(h,g)=>{const y=h==="ok";y||Ke("set at "+e+" failed: "+h);const x=wn(t.serverSyncTree_,c,!y);Wt(t.eventQueue_,e,x),ms(t,i,h,g)});const d=Mh(t,e);Tr(t,d),Wt(t.eventQueue_,d,[])}function Wv(t){hi(t,"onDisconnectEvents");const e=Fa(t),n=Yi();Po(t.onDisconnect_,te(),(i,r)=>{const o=vv(i,r,t.serverSyncTree_,e);ws(n,i,o)});let s=[];Po(n,te(),(i,r)=>{s=s.concat(yi(t.serverSyncTree_,i,r));const o=Mh(t,i);Tr(t,o)}),t.onDisconnect_=Yi(),Wt(t.eventQueue_,te(),s)}function Hv(t,e,n){t.server_.onDisconnectCancel(e.toString(),(s,i)=>{s==="ok"&&So(t.onDisconnect_,e),ms(t,n,s,i)})}function Pc(t,e,n,s){const i=ve(n);t.server_.onDisconnectPut(e.toString(),i.val(!0),(r,o)=>{r==="ok"&&ws(t.onDisconnect_,e,i),ms(t,s,r,o)})}function jv(t,e,n,s,i){const r=ve(n,s);t.server_.onDisconnectPut(e.toString(),r.val(!0),(o,a)=>{o==="ok"&&ws(t.onDisconnect_,e,r),ms(t,i,o,a)})}function qv(t,e,n,s){if(yo(n)){Be("onDisconnect().update() called with empty data.  Don't do anything."),ms(t,s,"ok",void 0);return}t.server_.onDisconnectMerge(e.toString(),n,(i,r)=>{i==="ok"&&$e(n,(o,a)=>{const l=ve(a);ws(t.onDisconnect_,we(e,o),l)}),ms(t,s,i,r)})}function Vv(t,e,n){let s;K(e._path)===".info"?s=Tc(t.infoSyncTree_,e,n):s=Tc(t.serverSyncTree_,e,n),Th(t.eventQueue_,e._path,s)}function xc(t,e,n){let s;K(e._path)===".info"?s=ir(t.infoSyncTree_,e,n):s=ir(t.serverSyncTree_,e,n),Th(t.eventQueue_,e._path,s)}function zv(t){t.persistentConnection_&&t.persistentConnection_.interrupt(Ov)}function hi(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),Be(n,...e)}function ms(t,e,n,s){e&&vs(()=>{if(n==="ok")e(null);else{const i=(n||"error").toUpperCase();let r=i;s&&(r+=": "+s);const o=new Error(r);o.code=i,e(o)}})}function Sh(t,e,n){return Aa(t.serverSyncTree_,e,n)||U.EMPTY_NODE}function $a(t,e=t.transactionQueueTree_){if(e||Ar(t,e),Cs(e)){const n=xh(t,e);b(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&Qv(t,vi(e),n)}else wh(e)&&Ir(e,n=>{$a(t,n)})}function Qv(t,e,n){const s=n.map(c=>c.currentWriteId),i=Sh(t,e,s);let r=i;const o=i.hash();for(let c=0;c<n.length;c++){const u=n[c];b(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const d=He(e,u.path);r=r.updateChild(d,u.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;t.server_.put(l.toString(),a,c=>{hi(t,"transaction put response",{path:l.toString(),status:c});let u=[];if(c==="ok"){const d=[];for(let h=0;h<n.length;h++)n[h].status=2,u=u.concat(wn(t.serverSyncTree_,n[h].currentWriteId)),n[h].onComplete&&d.push(()=>n[h].onComplete(null,!0,n[h].currentOutputSnapshotResolved)),n[h].unwatcher();Ar(t,La(t.transactionQueueTree_,e)),$a(t,t.transactionQueueTree_),Wt(t.eventQueue_,e,u);for(let h=0;h<d.length;h++)vs(d[h])}else{if(c==="datastale")for(let d=0;d<n.length;d++)n[d].status===3?n[d].status=4:n[d].status=0;else{Ke("transaction at "+l.toString()+" failed: "+c);for(let d=0;d<n.length;d++)n[d].status=4,n[d].abortReason=c}Tr(t,e)}},o)}function Tr(t,e){const n=Ph(t,e),s=vi(n),i=xh(t,n);return Kv(t,i,s),s}function Kv(t,e,n){if(e.length===0)return;const s=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=He(n,l.path);let u=!1,d;if(b(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)u=!0,d=l.abortReason,i=i.concat(wn(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=Lv)u=!0,d="maxretry",i=i.concat(wn(t.serverSyncTree_,l.currentWriteId,!0));else{const h=Sh(t,l.path,o);l.currentInputSnapshot=h;const g=e[a].update(h.val());if(g!==void 0){kr("transaction failed: Data returned ",g,l.path);let y=ve(g);typeof g=="object"&&g!=null&&xt(g,".priority")||(y=y.updatePriority(h.getPriority()));const k=l.currentWriteId,N=Fa(t),$=Eh(y,h,N);l.currentOutputSnapshotRaw=y,l.currentOutputSnapshotResolved=$,l.currentWriteId=Rh(t),o.splice(o.indexOf(k),1),i=i.concat(fh(t.serverSyncTree_,l.path,$,l.currentWriteId,l.applyLocally)),i=i.concat(wn(t.serverSyncTree_,k,!0))}else u=!0,d="nodata",i=i.concat(wn(t.serverSyncTree_,l.currentWriteId,!0))}Wt(t.eventQueue_,n,i),i=[],u&&(e[a].status=2,function(h){setTimeout(h,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(d==="nodata"?s.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):s.push(()=>e[a].onComplete(new Error(d),!1,null))))}Ar(t,t.transactionQueueTree_);for(let a=0;a<s.length;a++)vs(s[a]);$a(t,t.transactionQueueTree_)}function Ph(t,e){let n,s=t.transactionQueueTree_;for(n=K(e);n!==null&&Cs(s)===void 0;)s=La(s,n),e=ce(e),n=K(e);return s}function xh(t,e){const n=[];return Nh(t,e,n),n.sort((s,i)=>s.order-i.order),n}function Nh(t,e,n){const s=Cs(e);if(s)for(let i=0;i<s.length;i++)n.push(s[i]);Ir(e,i=>{Nh(t,i,n)})}function Ar(t,e){const n=Cs(e);if(n){let s=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[s]=n[i],s++);n.length=s,vh(e,n.length>0?n:void 0)}Ir(e,s=>{Ar(t,s)})}function Mh(t,e){const n=vi(Ph(t,e)),s=La(t.transactionQueueTree_,e);return Cv(s,i=>{zr(t,i)}),zr(t,s),Ch(s,i=>{zr(t,i)}),n}function zr(t,e){const n=Cs(e);if(n){const s=[];let i=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(b(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(b(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(wn(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&s.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?vh(e,void 0):n.length=r+1,Wt(t.eventQueue_,vi(e),i);for(let o=0;o<s.length;o++)vs(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ew{constructor(e,n){this._repo=e,this._path=n}cancel(){const e=new Ft;return Hv(this._repo,this._path,e.wrapCallback(()=>{})),e.promise}remove(){Fs("OnDisconnect.remove",this._path);const e=new Ft;return Pc(this._repo,this._path,null,e.wrapCallback(()=>{})),e.promise}set(e){Fs("OnDisconnect.set",this._path),Bo("OnDisconnect.set",e,this._path,!1);const n=new Ft;return Pc(this._repo,this._path,e,n.wrapCallback(()=>{})),n.promise}setWithPriority(e,n){Fs("OnDisconnect.setWithPriority",this._path),Bo("OnDisconnect.setWithPriority",e,this._path,!1),Sv("OnDisconnect.setWithPriority",n,!1);const s=new Ft;return jv(this._repo,this._path,e,n,s.wrapCallback(()=>{})),s.promise}update(e){Fs("OnDisconnect.update",this._path),Rv("OnDisconnect.update",e,this._path,!1);const n=new Ft;return qv(this._repo,this._path,e,n.wrapCallback(()=>{})),n.promise}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ua{constructor(e,n,s,i){this._repo=e,this._path=n,this._queryParams=s,this._orderByCalled=i}get key(){return Y(this._path)?null:ma(this._path)}get ref(){return new Nt(this._repo,this._path)}get _queryIdentifier(){const e=mc(this._queryParams),n=ua(e);return n==="{}"?"default":n}get _queryObject(){return mc(this._queryParams)}isEqual(e){if(e=Et(e),!(e instanceof Ua))return!1;const n=this._repo===e._repo,s=pa(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+Wy(this._path)}}class Nt extends Ua{constructor(e,n){super(e,n,new Ea,!1)}get parent(){const e=qd(this._path);return e===null?null:new Nt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class ps{constructor(e,n,s){this._node=e,this.ref=n,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new se(e),s=At(this.ref,e);return new ps(this._node.getChild(n),s,_e)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new ps(i,At(this.ref,s),_e)))}hasChild(e){const n=new se(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function z(t,e){return t=Et(t),t._checkNotDeleted("ref"),e!==void 0?At(t._root,e):t._root}function At(t,e){return t=Et(t),K(t._path)===null?Pv("child","path",e,!1):kh("child","path",e,!1),new Nt(t._repo,we(t._path,e))}function Mc(t){return t=Et(t),new ew(t._repo,t._path)}function le(t,e){t=Et(t),Fs("set",t._path),Bo("set",e,t._path,!1);const n=new Ft;return Uv(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function Wn(t){return t=Et(t),$v(t._repo,t).then(e=>new ps(e,new Nt(t._repo,t._path),t._queryParams.getIndex()))}class Wa{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const s=n._queryParams.getIndex();return new Oh("value",this,new ps(e.snapshotNode,new Nt(n._repo,n._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Lh(this,e,n):null}matches(e){return e instanceof Wa?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class Ha{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Lh(this,e,n):null}createEvent(e,n){b(e.childName!=null,"Child events should have a childName.");const s=At(new Nt(n._repo,n._path),e.childName),i=n._queryParams.getIndex();return new Oh(e.type,this,new ps(e.snapshotNode,s,i),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Ha?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function tw(t,e,n,s,i){let r;if(typeof s=="object"&&(r=void 0,i=s),typeof s=="function"&&(r=s),i&&i.onlyOnce){const l=n,c=(u,d)=>{xc(t._repo,t,a),l(u,d)};c.userCallback=n.userCallback,c.context=n.context,n=c}const o=new Zv(n,r||void 0),a=e==="value"?new Wa(o):new Ha(e,o);return Vv(t._repo,t,a),()=>xc(t._repo,t,a)}function ut(t,e,n,s){return tw(t,"value",e,n,s)}ZE(Nt);iv(Nt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bh="firebasestorage.googleapis.com",Dh="storageBucket",dw=2*60*1e3,hw=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class et{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let s;try{s=et.makeFromUrl(e,n)}catch{return new et(e,"")}if(s.path==="")return s;throw ww(e)}static makeFromUrl(e,n){let s=null;const i="([A-Za-z0-9.\\-_]+)";function r(H){H.path.charAt(H.path.length-1)==="/"&&(H.path_=H.path_.slice(0,-1))}const o="(/(.*))?$",a=new RegExp("^gs://"+i+o,"i"),l={bucket:1,path:3};function c(H){H.path_=decodeURIComponent(H.path)}const u="v[A-Za-z0-9_]+",d=n.replace(/[.]/g,"\\."),h="(/([^?#]*).*)?$",g=new RegExp(`^https?://${d}/${u}/b/${i}/o${h}`,"i"),y={bucket:1,path:3},x=n===Bh?"(?:storage.googleapis.com|storage.cloud.google.com)":n,k="([^?#]*)",N=new RegExp(`^https?://${x}/${i}/${k}`,"i"),W=[{regex:a,indices:l,postModify:r},{regex:g,indices:y,postModify:c},{regex:N,indices:{bucket:1,path:2},postModify:c}];for(let H=0;H<W.length;H++){const Ie=W[H],Le=Ie.regex.exec(e);if(Le){const at=Le[Ie.indices.bucket];let vt=Le[Ie.indices.path];vt||(vt=""),s=new et(at,vt),Ie.postModify(s);break}}if(s==null)throw vw(e);return s}}class Tw{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sw(t){return t!==void 0}function Pw(t){return typeof t=="object"&&!Array.isArray(t)}function Va(t){return typeof t=="string"||t instanceof String}function Oc(t){return za()&&t instanceof Blob}function za(){return typeof Blob<"u"}function Lc(t,e,n,s){if(s<e)throw Fo(`Invalid value for '${t}'. Expected ${e} or greater.`);if(s>n)throw Fo(`Invalid value for '${t}'. Expected ${n} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xw{constructor(e,n,s,i,r,o,a,l,c,u,d){this.url_=e,this.method_=n,this.headers_=s,this.body_=i,this.successCodes_=r,this.additionalRetryCodes_=o,this.callback_=a,this.errorCallback_=l,this.timeout_=c,this.progressCallback_=u,this.connectionFactory_=d,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((h,g)=>{this.resolve_=h,this.reject_=g,this.start_()})}start_(){const e=(s,i)=>{if(i){s(!1,new Ri(!1,null,!0));return}const r=this.connectionFactory_();this.pendingConnection_=r;const o=a=>{const l=a.loaded,c=a.lengthComputable?a.total:-1;this.progressCallback_!==null&&this.progressCallback_(l,c)};this.progressCallback_!==null&&r.addUploadProgressListener(o),r.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&r.removeUploadProgressListener(o),this.pendingConnection_=null;const a=r.getErrorCode()===kn.NO_ERROR,l=r.getStatus();if(!a||this.isRetryStatusCode_(l)){const u=r.getErrorCode()===kn.ABORT;s(!1,new Ri(!1,null,u));return}const c=this.successCodes_.indexOf(l)!==-1;s(!0,new Ri(c,r))})},n=(s,i)=>{const r=this.resolve_,o=this.reject_,a=i.connection;if(i.wasSuccessCode)try{const l=this.callback_(a,a.getResponse());Sw(l)?r(l):r()}catch(l){o(l)}else if(a!==null){const l=qa();l.serverResponse=a.getErrorText(),this.errorCallback_?o(this.errorCallback_(a,l)):o(l)}else if(i.canceled){const l=this.appDelete_?Fh():Ew();o(l)}else{const l=yw();o(l)}};this.canceled_?n(!1,new Ri(!1,null,!0)):this.backoffId_=Aw(e,n,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&Rw(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}isRetryStatusCode_(e){const n=e>=500&&e<600,i=[408,429].indexOf(e)!==-1,r=this.additionalRetryCodes_.indexOf(e)!==-1;return n||i||r}}class Ri{constructor(e,n,s){this.wasSuccessCode=e,this.connection=n,this.canceled=!!s}}function Nw(t,e){e!==null&&e.length>0&&(t.Authorization="Firebase "+e)}function Mw(t,e){t["X-Firebase-Storage-Version"]="webjs/"+(e!=null?e:"AppManager")}function Ow(t,e){e&&(t["X-Firebase-GMPID"]=e)}function Lw(t,e){e!==null&&(t["X-Firebase-AppCheck"]=e)}function Bw(t,e,n,s,i,r){const o=Gh(t.urlParams),a=t.url+o,l=Object.assign({},t.headers);return Ow(l,e),Nw(l,n),Mw(l,r),Lw(l,s),new xw(a,t.method,l,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const St={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class Kr{constructor(e,n){this.data=e,this.contentType=n||null}}function Uw(t,e){switch(t){case St.RAW:return new Kr($h(e));case St.BASE64:case St.BASE64URL:return new Kr(Uh(t,e));case St.DATA_URL:return new Kr(Hw(e),jw(e))}throw qa()}function $h(t){const e=[];for(let n=0;n<t.length;n++){let s=t.charCodeAt(n);if(s<=127)e.push(s);else if(s<=2047)e.push(192|s>>6,128|s&63);else if((s&64512)===55296)if(!(n<t.length-1&&(t.charCodeAt(n+1)&64512)===56320))e.push(239,191,189);else{const r=s,o=t.charCodeAt(++n);s=65536|(r&1023)<<10|o&1023,e.push(240|s>>18,128|s>>12&63,128|s>>6&63,128|s&63)}else(s&64512)===56320?e.push(239,191,189):e.push(224|s>>12,128|s>>6&63,128|s&63)}return new Uint8Array(e)}function Ww(t){let e;try{e=decodeURIComponent(t)}catch{throw zs(St.DATA_URL,"Malformed data URL.")}return $h(e)}function Uh(t,e){switch(t){case St.BASE64:{const i=e.indexOf("-")!==-1,r=e.indexOf("_")!==-1;if(i||r)throw zs(t,"Invalid character '"+(i?"-":"_")+"' found: is it base64url encoded?");break}case St.BASE64URL:{const i=e.indexOf("+")!==-1,r=e.indexOf("/")!==-1;if(i||r)throw zs(t,"Invalid character '"+(i?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=$w(e)}catch{throw zs(t,"Invalid character found")}const s=new Uint8Array(n.length);for(let i=0;i<n.length;i++)s[i]=n.charCodeAt(i);return s}class Wh{constructor(e){this.base64=!1,this.contentType=null;const n=e.match(/^data:([^,]+)?,/);if(n===null)throw zs(St.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const s=n[1]||null;s!=null&&(this.base64=qw(s,";base64"),this.contentType=this.base64?s.substring(0,s.length-7):s),this.rest=e.substring(e.indexOf(",")+1)}}function Hw(t){const e=new Wh(t);return e.base64?Uh(St.BASE64,e.rest):Ww(e.rest)}function jw(t){return new Wh(t).contentType}function qw(t,e){return t.length>=e.length?t.substring(t.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zt{constructor(e,n){let s=0,i="";Oc(e)?(this.data_=e,s=e.size,i=e.type):e instanceof ArrayBuffer?(n?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),s=this.data_.length):e instanceof Uint8Array&&(n?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),s=e.length),this.size_=s,this.type_=i}size(){return this.size_}type(){return this.type_}slice(e,n){if(Oc(this.data_)){const s=this.data_,i=Gw(s,e,n);return i===null?null:new Zt(i)}else{const s=new Uint8Array(this.data_.buffer,e,n-e);return new Zt(s,!0)}}static getBlob(...e){if(za()){const n=e.map(s=>s instanceof Zt?s.data_:s);return new Zt(Fw.apply(null,n))}else{const n=e.map(o=>Va(o)?Uw(St.RAW,o).data:o.data_);let s=0;n.forEach(o=>{s+=o.byteLength});const i=new Uint8Array(s);let r=0;return n.forEach(o=>{for(let a=0;a<o.length;a++)i[r++]=o[a]}),new Zt(i,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hh(t){let e;try{e=JSON.parse(t)}catch{return null}return Pw(e)?e:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const Xh="storage";function Gc(t,e,n){return t=Et(t),lC(t,e,n)}function $c(t){return t=Et(t),cC(t)}function Yr(t){return t=Et(t),uC(t)}function Kt(t,e){return t=Et(t),mC(t,e)}function pC(t=vd(),e){return t=Et(t),yd(t,Xh).getImmediate({identifier:e})}function gC(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),i=t.getProvider("app-check-internal");return new Xa(n,s,i,e,Ed)}function _C(){ni(new us(Xh,gC,"PUBLIC").setMultipleInstances(!0)),rn(Dc,Fc,""),rn(Dc,Fc,"esm2017")}_C();const yC="data:image/png;base64,";let it,Te,Fe,Ve,O,yn,M=0,Uc;function EC(){clearTimeout(it),clearTimeout(Ve),clearInterval(Fe),clearInterval(yn),p.data().leaveGame()}function vC(){p.data().pickedGame.players.filter(e=>e.inGame==!0).length>1&&p.data().startGame()}function Jh(t){p.data().pickedGame.isHost=="NoHost"?p.data().informVoiting(t.currentTarget.innerText):p.data().hostVoited(t.currentTarget.innerText)}function Hn(){this.onAnswered;let t;if(p.data().pickedGame.gameLine.turn.id!==p.data().uid)if(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers!==void 0&&p.data().pickedGame.pickedPack.rounds[M].wrongAnswers!==null)if(Array.isArray(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O]))if(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O].length>0){let e=Array.from(document.getElementsByClassName("answersTest")).find(n=>n.value==p.data().pickedGame.gameLine.answer.answer);e&&(e.parentElement.style.color="orange")}else document.getElementById("answerLbl").innerText=p.data().pickedGame.gameLine.answer.answer;else document.getElementById("answerLbl").innerText=p.data().pickedGame.gameLine.answer.answer;else document.getElementById("answerLbl").innerText=p.data().pickedGame.gameLine.answer.answer;for(p.data().pickedGame.gameLine.turn.id==p.data().uid&&(O=p.data().pickedGame.gameLine.pikedQuestion,t=document.getElementById("answerInp").value,Array.isArray(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers)&&Array.isArray(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O])&&p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O].length>0&&(t=Array.from(document.getElementsByClassName("answersTest")).find(e=>e.checked===!0),t=t?t.value:!1),p.data().onAnswer(t,O));document.getElementById("onAnsweredBtn");)document.getElementById("onAnsweredBtn").remove();if(document.getElementById("answerLbl").innerText=document.getElementById("answerInp").value,document.getElementById("answerInp").style.display="none",document.getElementById("answerInp").value="",clearTimeout(it),clearTimeout(Ve),clearInterval(Fe),p.data().pickedGame.pickedPack.rounds[M].wrongAnswers!==void 0)if(Array.isArray(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O]))if(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O].length>0){let e=Array.from(document.getElementsByClassName("answersTest")).find(n=>n.value==p.data().pickedGame.pickedPack.rounds[M].answers[O]);e.parentElement.style.color="green"}else document.getElementById("rightAnswerLbl").innerText=p.data().pickedGame.pickedPack.rounds[M].answers[O],document.getElementsByClassName("fileMediaElement")[0]!==void 0&&document.getElementsByClassName("fileMediaElement")[0].tagName!=="IMG"&&(document.getElementsByClassName("fileMediaElement")[0].firstElementChild.remove(),document.getElementsByClassName("fileMediaElement")[0].remove());else document.getElementById("rightAnswerLbl").innerText=p.data().pickedGame.pickedPack.rounds[M].answers[O],document.getElementsByClassName("fileMediaElement")[0]!==void 0&&document.getElementsByClassName("fileMediaElement")[0].tagName!=="IMG"&&(document.getElementsByClassName("fileMediaElement")[0].firstElementChild.remove(),document.getElementsByClassName("fileMediaElement")[0].remove());else document.getElementById("rightAnswerLbl").innerText=p.data().pickedGame.pickedPack.rounds[M].answers[O],document.getElementsByClassName("fileMediaElement")[0]!==void 0&&document.getElementsByClassName("fileMediaElement")[0].tagName!=="IMG"&&(document.getElementsByClassName("fileMediaElement")[0].firstElementChild.remove(),document.getElementsByClassName("fileMediaElement")[0].remove());p.data().pickedGame.gameLine.turn.id!==p.data().uid&&(document.getElementById("answerLbl").innerText=p.data().pickedGame.gameLine.answer.answer),(p.data().pickedGame.isHost=="Host"&&p.data().pickedGame.host.id==p.data().uid||p.data().pickedGame.isHost=="NoHost"&&p.data().pickedGame.gameLine.turn.id!==p.data().uid)&&document.getElementsByClassName("markAnswerBtns").length<1&&(document.getElementById("questionBlock").insertAdjacentHTML("beforeend",`
                        ...
                        `),Array.from(document.getElementsByClassName("markAnswerBtns")).forEach(e=>e.addEventListener("click",Jh)))}function Wc(){let t=Math.round(Math.random()*Array.from(document.getElementsByClassName("answersTest")).length);if(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers){let e=p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O];if(Array.isArray(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O])&&e.length>0){for(p.data().uid==p.data().pickedGame.gameLine.turn.id&&p.data().informWrongAnswer(t),document.getElementById("testTypeAnswer").style.display="grid";document.getElementById("testTypeAnswer").getElementsByTagName("form")[0].firstElementChild;)document.getElementById("testTypeAnswer").getElementsByTagName("form")[0].firstElementChild.remove();for(let n=0;n<e.length;n++)document.getElementById("testTypeAnswer").getElementsByTagName("form")[0].insertAdjacentHTML("beforeend",`
                                ...
                                <div><input type="radio" class="answersTest" name="answers" value="${p.data().pickedGame.pickedPack.rounds[M].answers[O]}">
                                <label>${p.data().pickedGame.pickedPack.rounds[M].answers[O]}</label></div>`):Array.from(document.getElementsByClassName("answersTest"))[t].parentElement.insertAdjacentHTML("beforebegin",`
                                <div><input type="radio" class="answersTest" name="answers" value="${p.data().pickedGame.pickedPack.rounds[M].answers[O]}">
                                <label>${p.data().pickedGame.pickedPack.rounds[M].answers[O]}</label></div>`)}}}function wC(){p.data().pickedGame.host.id==p.data().uid&&(document.getElementById("questionBlock").style.display!=="none"&&(p.data().onAnswer(!1,O),document.getElementById("questionBlock").style.display="none",document.getElementById("tableWithQuestions").style.display="grid"),p.data().nextRound())}const CC={data(){return{pickedGame:p.data().pickedGame,players:p.data().pickedGame?p.data().pickedGame.players:null,startGame:function(){this.showPlayers(),this.showHeader(),this.showMain(),p.data().setGameDataListeners()},showPlayers:function(){if(document.getElementById("playersBlock"))for(;document.getElementById("playersBlock").firstElementChild;)document.getElementById("playersBlock").firstElementChild.remove();let t=p.data().pickedGame.players.filter(e=>e.inGame==!0);for(let e=0;e<t.length;e++)document.getElementById("playersBlock").insertAdjacentHTML("beforeend",`
                        <div class="player">
                ...
                <label id="timerForGame"></label>`),document.getElementById("leaveBtn").addEventListener("click",EC)},showMain:function(){if(!document.getElementById("tableWithQuestions").firstElementChild){document.getElementById("tableWithQuestions").insertAdjacentHTML("beforeend",'<input disabled="disabled" value="Category">');for(let e=0;e<this.pickedGame.pickedPack.rounds[M].points.length;e++)document.getElementById("tableWithQuestions").insertAdjacentHTML("beforeend",`<div class="points">${this.pickedGame.pickedPack.rounds[M].points[e]}</div>`);let t=this.pickedGame.pickedPack.rounds[M].categories?this.pickedGame.pickedPack.rounds[M].categories.length:0;for(let e=0;e<Math.max(Math.min(7,Math.ceil(this.pickedGame.pickedPack.rounds[M].questions.findLastIndex(n=>n!=="")/this.pickedGame.pickedPack.rounds[M].points.length)),t);e++){this.pickedGame.pickedPack.rounds[M].categories!==void 0?document.getElementById("tableWithQuestions").insertAdjacentHTML("beforeend",`<div class="category">${this.pickedGame.pickedPack.rounds[M].categories[e]}</div>`):document.getElementById("tableWithQuestions").insertAdjacentHTML("beforeend",`<div class="category">Category ${e+1}</div>`);for(let n=0;n<this.pickedGame.pickedPack.rounds[M].points.length;n++)document.getElementById("tableWithQuestions").insertAdjacentHTML("beforeend",'<div class="qustions"><img class="questionMark" src="/img/questionMark.png" alt="?"></div>')}Array.from(document.getElementsByClassName("qustions")).forEach(e=>e.addEventListener("click",this.onQuestion))}},showGameInfo:function(){document.getElementById("showBlock").style.display="grid",document.getElementById("mainLbl").innerText=p.data().pickedGame.name,document.getElementById("subMainLbl").innerText=p.data().pickedGame.host.name,setTimeout(()=>{document.getElementById("mainLbl").innerText=p.data().pickedGame.pickedPack.name,document.getElementById("subMainLbl").innerText=p.data().pickedGame.pickedPack.author,setTimeout(()=>{for(document.getElementById("mainLbl").style.display="none",document.getElementById("subMainLbl").style.display="none";document.getElementById("showBlock").firstElementChild;)document.getElementById("showBlock").firstElementChild.remove();if(p.data().pickedGame.pickedPack.rounds[0].categories!==void 0)for(let t=0;t<p.data().pickedGame.pickedPack.rounds[0].categories.length;t++)document.getElementById("showBlock").insertAdjacentHTML("beforeend",`<label>${p.data().pickedGame.pickedPack.rounds[0].categories[t]}<label>`);else for(let t=0;t<Array.from(document.getElementsByClassName("category")).length;t++)document.getElementById("showBlock").insertAdjacentHTML("beforeend",`<label>Category ${t+1}<label>`);setTimeout(()=>{document.getElementById("showBlock").style.display="none",document.getElementById("startingGame")&&(document.getElementById("startingGame").remove(),document.getElementById("gameCode")&&document.getElementById("gameCode").remove(),document.getElementById("headerOfGame").insertAdjacentHTML("beforeend",`
                                    <button id="pauseGame"><img src="img/pause.png" alt="pause"></button>
                                    <button id="skipQuestion">></button>
                                    <button id="skipRound">> ></button>`),document.getElementById("pauseGame").addEventListener("click",this.onPauseGameBtn),document.getElementById("skipQuestion").addEventListener("click",this.onSkipQuestionBtn),document.getElementById("skipRound").addEventListener("click",this.onSkipRoundBtn)),this.nextTurn()},3e3)},2e3)},2e3)},onPauseGameBtn:function(){p.data().pickedGame.host.id==p.data().uid&&(this.pauseGame,p.data().pauseGame())},pauseGame:function(){if(p.data().pickedGame.gameLine.paused)document.getElementById("pauseWindow").style.display="grid",document.getElementById("resumeGameBtn").style.display="none",clearTimeout(it),clearTimeout(Ve),clearInterval(Fe),clearInterval(yn),p.data().pickedGame.host.id==p.data().uid&&(document.getElementById("resumeGameBtn").style.display="block"),document.getElementsByClassName("fileMediaElement")[0]!==void 0&&document.getElementsByClassName("fileMediaElement")[0].tagName!=="IMG"&&document.getElementsByClassName("fileMediaElement")[0].pause();else{document.getElementById("pauseWindow").style.display="none";let t=document.getElementById("timerForGame").innerText;document.getElementById("tableWithQuestions").style.display!=="none"?(Te=t,Fe=setInterval(()=>{Te--,document.getElementById("timerForGame").innerText=Te},1e3),it=setTimeout(()=>{this.pickRandomQuestion(),clearInterval(Fe)},t*1e3)):(Te=t,Ve=setTimeout(Hn,t*1e3),Fe=setInterval(()=>{Te--,document.getElementById("timerForGame").innerText=Te},1e3)),document.getElementsByClassName("fileMediaElement")[0]!==void 0&&document.getElementsByClassName("fileMediaElement")[0].tagName!=="IMG"&&document.getElementsByClassName("fileMediaElement")[0].play()}},onSkipQuestionBtn:function(){p.data().pickedGame.host.id==p.data().uid&&document.getElementById("questionBlock").style.display!=="none"&&(p.data().onAnswer(!1,O),document.getElementById("questionBlock").style.display="none",document.getElementById("tableWithQuestions").style.display="grid",Array.from(document.getElementsByClassName("questionMark")).length>0?p.data().nextTurn():wC())},onSkipRoundBtn:function(){p.data().pickedGame.host.id==p.data().uid&&(document.getElementById("questionBlock").style.display!=="none"&&(p.data().onAnswer(!1,O),document.getElementById("questionBlock").style.display="none",document.getElementById("tableWithQuestions").style.display="grid"),p.data().nextRound())},onResumeGame:function(){p.data().pickedGame.host.id==p.data().uid&&(document.getElementById("pauseWindow").style.display="none",p.data().resumeGame())},wrongAnswersAdd:function(t){if(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers){let e=p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O];if(Array.isArray(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O])&&e.length>0){for(p.data().uid==p.data().pickedGame.gameLine.turn.id&&p.data().informWrongAnswer(t),document.getElementById("testTypeAnswer").style.display="grid";document.getElementById("testTypeAnswer").getElementsByTagName("form")[0].firstElementChild;)document.getElementById("testTypeAnswer").getElementsByTagName("form")[0].firstElementChild.remove();for(let n=0;n<e.length;n++)document.getElementById("testTypeAnswer").getElementsByTagName("form")[0].insertAdjacentHTML("beforeend",`
                                <div><input type="radio" class="answersTest" name="answers" value="${e[n]}">
                                <label>${e[n]}</label></div>`);t>Array.from(document.getElementsByClassName("answersTest")).length-1?Array.from(document.getElementsByClassName("answersTest"))[t-1]!==void 0?Array.from(document.getElementsByClassName("answersTest"))[t-1].parentElement.insertAdjacentHTML("afterend",`
                                    <div><input type="radio" class="answersTest" name="answers" value="${p.data().pickedGame.pickedPack.rounds[M].answers[O]}">
                                    <label>${p.data().pickedGame.pickedPack.rounds[M].answers[O]}</label></div>`):Array.from(document.getElementsByClassName("answersTest"))[t].parentElement.insertAdjacentHTML("beforebegin",`
                                <div><input type="radio" class="answersTest" name="answers" value="${p.data().pickedGame.pickedPack.rounds[M].answers[O]}">
                                <label>${p.data().pickedGame.pickedPack.rounds[M].answers[O]}</label></div>`):Array.from(document.getElementsByClassName("answersTest"))[t].parentElement.insertAdjacentHTML("beforebegin",`
                                <div><input type="radio" class="answersTest" name="answers" value="${p.data().pickedGame.pickedPack.rounds[M].answers[O]}">
                                <label>${p.data().pickedGame.pickedPack.rounds[M].answers[O]}</label></div>`)}}},onFinishGameLeave:function(){clearTimeout(it),clearTimeout(Ve),clearInterval(Fe),clearInterval(yn),p.data().leaveGame()},onQuestionPick:function(){document.getElementById("nowTurnPlayerName").innerText=p.data().pickedGame.gameLine.turn.name,clearInterval(Fe),clearTimeout(it),clearTimeout(Ve),Te=p.data().pickedGame.timeOnPickQuestion,document.getElementById("timerForGame").innerText=Te,Fe=setInterval(()=>{Te--,document.getElementById("timerForGame").innerText=Te},1e3),it=setTimeout(()=>{this.pickRandomQuestion(),clearInterval(Fe)},p.data().pickedGame.timeOnPickQuestion*1e3)},onQuestion:function(t){if(p.data().uid==p.data().pickedGame.gameLine.turn.id&&Array.from(t.currentTarget.getElementsByClassName("questionMark")).length>0){for(document.getElementById("chooseRightOrWrongAnswer")&&document.getElementById("chooseRightOrWrongAnswer").remove(),document.getElementById("rightAnswerLbl").innerText="",document.getElementById("answerLbl").innerText="",clearTimeout(it),clearTimeout(Ve),clearInterval(Fe),Te=p.data().pickedGame.timeOnGiveAnswer,Fe=setInterval(()=>{Te--,document.getElementById("timerForGame").innerText=Te},1e3),O=Array.from(document.getElementsByClassName("qustions")).indexOf(t.currentTarget),p.data().informPickedQuestion(O),document.getElementById("questionBlock").style.display="grid",document.getElementById("tableWithQuestions").style.display="none",document.getElementById("questionLbl").innerText=p.data().pickedGame.pickedPack.rounds[M].questions[O];document.getElementById("mediaFile").firstElementChild;)document.getElementById("mediaFile").firstElementChild.remove();p.data().pickedGame.pickedPack.rounds[M].mediaFiles!==void 0&&p.data().pickedGame.pickedPack.rounds[M].mediaFiles[O]!==""&&p.data().getQnFile(M,O),document.getElementById("testTypeAnswer").style.display="none",Wc(),document.getElementById("questionBlock").insertAdjacentHTML("beforeend",'<button id="onAnsweredBtn">Answered</button>'),document.getElementById("onAnsweredBtn").addEventListener("click",Hn),p.data().pickedGame.answerType=="Text"&&Array.from(document.getElementsByClassName("answersTest")).length<1?document.getElementById("answerInp").style.display="block":document.getElementById("answerInp").style.display="none",Ve=setTimeout(Hn,p.data().pickedGame.timeOnGiveAnswer*1e3),Array.from(document.getElementsByClassName("qustions"))[O].removeEventListener("click",this.onQuestion),Array.from(document.getElementsByClassName("qustions"))[O].getElementsByClassName("questionMark")[0].remove()}},onGetQuestion:function(){if(p.data().uid!==p.data().pickedGame.gameLine.turn.id){for(clearTimeout(it),clearInterval(Fe),clearTimeout(Ve),Te=p.data().pickedGame.timeOnGiveAnswer,yn=setInterval(()=>{Te--,document.getElementById("timerForGame").innerText=Te},1e3),document.getElementById("questionBlock").style.display="grid",document.getElementById("tableWithQuestions").style.display="none",document.getElementById("chooseRightOrWrongAnswer")&&document.getElementById("chooseRightOrWrongAnswer").remove(),document.getElementById("rightAnswerLbl").innerText="",document.getElementById("answerLbl").innerText="",O=p.data().pickedGame.gameLine.pikedQuestion,document.getElementById("questionLbl").innerText=p.data().pickedGame.pickedPack.rounds[M].questions[O];document.getElementById("mediaFile").firstElementChild;)document.getElementById("mediaFile").firstElementChild.remove();for(p.data().pickedGame.pickedPack.rounds[M].mediaFiles!==void 0&&p.data().pickedGame.pickedPack.rounds[M].mediaFiles[O]!==""&&p.data().getQnFile(M,O),document.getElementById("testTypeAnswer").style.display="none";document.getElementById("onAnsweredBtn");)document.getElementById("onAnsweredBtn").remove();document.getElementById("answerInp").style.display="none",Ve=setTimeout(Hn,p.data().pickedGame.timeOnGiveAnswer*1e3),Array.from(document.getElementsByClassName("qustions"))[O].removeEventListener("click",this.onQuestion),Array.from(document.getElementsByClassName("qustions"))[O].getElementsByClassName("questionMark")[0]!==void 0&&Array.from(document.getElementsByClassName("qustions"))[O].getElementsByClassName("questionMark")[0].remove()}},nextTurn:function(){Array.from(document.getElementsByClassName("questionMark")).length>0?(document.getElementById("questionBlock").style.display="none",document.getElementById("tableWithQuestions").style.display="grid",p.data().nextTurn()):p.data().nextRound()},pickRandomQuestion:function(){if(Array.from(document.getElementsByClassName("questionMark")).length>0&&(O=Math.round(Math.random()*(Array.from(document.getElementsByClassName("questionMark")).length-1)),p.data().uid==p.data().pickedGame.gameLine.turn.id)){for(document.getElementById("chooseRightOrWrongAnswer")&&document.getElementById("chooseRightOrWrongAnswer").remove(),document.getElementById("answerLbl").innerText="",clearTimeout(it),clearTimeout(Ve),clearInterval(Fe),Te=p.data().pickedGame.timeOnGiveAnswer,yn=setInterval(()=>{Te--,document.getElementById("timerForGame").innerText=Te},1e3),p.data().informPickedQuestion(O),document.getElementById("questionBlock").style.display="grid",document.getElementById("tableWithQuestions").style.display="none",document.getElementById("questionLbl").innerText=p.data().pickedGame.pickedPack.rounds[M].questions[O];document.getElementById("mediaFile").firstElementChild;)document.getElementById("mediaFile").firstElementChild.remove();p.data().pickedGame.pickedPack.rounds[M].mediaFiles!==void 0&&p.data().pickedGame.pickedPack.rounds[M].mediaFiles[O]!==""&&p.data().getQnFile(M,O),document.getElementById("testTypeAnswer").style.display="none",Wc(),document.getElementById("questionBlock").insertAdjacentHTML("beforeend",'<button id="onAnsweredBtn">Answered</button>'),document.getElementById("onAnsweredBtn").addEventListener("click",Hn),p.data().pickedGame.answerType=="Text"&&Array.from(document.getElementsByClassName("answersTest")).length<1?document.getElementById("answerInp").style.display="block":document.getElementById("answerInp").style.display="none",Ve=setTimeout(Hn,p.data().pickedGame.timeOnGiveAnswer*1e3),Array.from(document.getElementsByClassName("qustions"))[O].removeEventListener("click",this.onQuestion),Array.from(document.getElementsByClassName("qustions"))[O].getElementsByClassName("questionMark")[0]&&Array.from(document.getElementsByClassName("qustions"))[O].getElementsByClassName("questionMark")[0].remove()}},nextRound:function(){for(clearTimeout(it),clearTimeout(Ve),clearInterval(Fe),clearInterval(yn),M=p.data().pickedGame.gameLine.round,document.getElementById("showBlock").style.display="grid";document.getElementById("showBlock").firstElementChild;)document.getElementById("showBlock").firstElementChild.remove();if(p.data().pickedGame.pickedPack.rounds[M].categories!==void 0)for(let t=0;t<p.data().pickedGame.pickedPack.rounds[M].categories.length;t++)document.getElementById("showBlock").insertAdjacentHTML("beforeend",`<label>${p.data().pickedGame.pickedPack.rounds[M].categories[t]}<label>`);else for(let t=0;t<Array.from(document.getElementsByClassName("category")).length;t++)document.getElementById("showBlock").insertAdjacentHTML("beforeend",`<label>Category ${t+1}<label>`);setTimeout(()=>{for(document.getElementById("showBlock").style.display="none";document.getElementById("tableWithQuestions").firstElementChild;)document.getElementById("tableWithQuestions").firstElementChild.remove();this.showMain(),this.nextTurn()},3e3)},announceWinner:function(){let t;for(let e=0;e<p.data().pickedGame.players.length-1;e++)p.data().pickedGame.players[e].points>p.data().pickedGame.players[e+1].points?t=p.data().pickedGame.players[e].name:t=p.data().pickedGame.players[e+1].name;document.getElementById("announceWinnerBlock").style.display="grid",document.getElementById("winerIsPlayer").innerText=t},onAnswered:function(){if(clearTimeout(it),clearTimeout(Ve),clearInterval(Fe),clearInterval(yn),O!=null){if(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers)if(Array.isArray(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O])){if(p.data().pickedGame.gameLine.turn.id!==p.data().uid)if(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O].length>0){let e=Array.from(document.getElementsByClassName("answersTest")).find(n=>n.value==p.data().pickedGame.gameLine.answer.answer);e!==void 0&&(e.parentElement.style.color="orange")}else document.getElementById("answerLbl").innerText=p.data().pickedGame.gameLine.answer.answer;if(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O].length>0){let e=Array.from(document.getElementsByClassName("answersTest")).find(n=>n.value==p.data().pickedGame.pickedPack.rounds[M].answers[O]);e!==void 0&&(e.parentElement.style.color="green")}else document.getElementById("rightAnswerLbl").innerText=p.data().pickedGame.pickedPack.rounds[M].answers[O],document.getElementsByClassName("fileMediaElement")[0]!==void 0&&document.getElementsByClassName("fileMediaElement")[0].tagName!=="IMG"&&(document.getElementsByClassName("fileMediaElement")[0].firstElementChild.remove(),document.getElementsByClassName("fileMediaElement")[0].remove());p.data().pickedGame.host.id==p.data().uid&&p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O].length>0&&setTimeout(()=>{let e=p.data().pickedGame.gameLine.answer.answer===p.data().pickedGame.pickedPack.rounds[M].answers[O]?"Right":"Wrong";p.data().hostVoited(e)},3e3)}else document.getElementById("answerLbl").innerText=p.data().pickedGame.gameLine.answer.answer,document.getElementById("rightAnswerLbl").innerText=p.data().pickedGame.pickedPack.rounds[M].answers[O],document.getElementsByClassName("fileMediaElement")[0]!==void 0&&document.getElementsByClassName("fileMediaElement")[0].tagName!=="IMG"&&(document.getElementsByClassName("fileMediaElement")[0].firstElementChild.remove(),document.getElementsByClassName("fileMediaElement")[0].remove());else document.getElementById("answerLbl").innerText=p.data().pickedGame.gameLine.answer.answer,document.getElementById("rightAnswerLbl").innerText=p.data().pickedGame.pickedPack.rounds[M].answers[O],document.getElementsByClassName("fileMediaElement")[0]!==void 0&&document.getElementsByClassName("fileMediaElement")[0].tagName!=="IMG"&&(document.getElementsByClassName("fileMediaElement")[0].firstElementChild.remove(),document.getElementsByClassName("fileMediaElement")[0].remove());let t;p.data().pickedGame.pickedPack.rounds[M].wrongAnswers&&Array.isArray(p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O])?t=p.data().pickedGame.pickedPack.rounds[M].wrongAnswers[O].length<1:t=!0,(p.data().pickedGame.isHost=="Host"&&p.data().pickedGame.host.id==p.data().uid&&t||p.data().pickedGame.isHost=="NoHost"&&p.data().pickedGame.gameLine.turn.id!==p.data().uid&&t)&&document.getElementsByClassName("markAnswerBtns").length<1&&(document.getElementById("questionBlock").insertAdjacentHTML("beforeend",`
                            <div id="chooseRightOrWrongAnswer">
                            <button class="markAnswerBtns" id="wrongAnswerBtn">Wrong</button>
                            <button class="markAnswerBtns" id="rightAnswerBtn">Right</button>
                            </div>
                            `),Array.from(document.getElementsByClassName("markAnswerBtns")).forEach(e=>e.addEventListener("click",Jh)))}}}}},bC={id:"game"},IC=ju('<div id="showBlock"><label id="mainLbl"></label><label id="subMainLbl"></label></div><div id="gameBlock"><div id="headerOfGame"></div><div id="tableWithQuestions"></div><div id="questionBlock"><label id="questionLbl"></label><div id="mediaFile"></div><div id="testTypeAnswer"><form></form></div><label id="answerLbl"></label><input id="answerInp" type="text"><label id="rightAnswerLbl"></label></div><div id="playersBlock"></div></div>',2),kC={id:"pauseWindow"},TC=Re("label",null,"Game Paused",-1),AC=Re("img",{src:yC,alt:"resume"},null,-1),RC=[AC],SC=Re("input",{id:"changePointsInp",type:"number"},null,-1),PC=Re("label",null,"Winner is",-1),xC=Re("label",{id:"winerIsPlayer"},null,-1),NC=[PC,xC];function MC(t,e,n,s,i,r){return mr(),Uu("div",bC,[IC,Re("div",kC,[TC,Re("button",{id:"resumeGameBtn",onClick:e[0]||(e[0]=o=>i.onResumeGame())},RC)]),Re("div",{id:"playerChangePointsBlock",onClick:e[4]||(e[4]=o=>i.closePointchangeWindow(o))},[Re("div",{id:"playerChangePoints",onClick:e[3]||(e[3]=o=>o.stopPropagation())},[Re("button",{onClick:e[1]||(e[1]=o=>i.onChangePointsInpBtns(o))},"+"),SC,Re("button",{onClick:e[2]||(e[2]=o=>i.onChangePointsInpBtns(o))},"-")])]),Re("div",{id:"announceWinnerBlock",onClick:e[5]||(e[5]=o=>i.onFinishGameLeave())},NC)])}const ye=ia(CC,[["render",MC]]),OC=Object.freeze(Object.defineProperty({__proto__:null,default:ye},Symbol.toStringTag,{value:"Module"})),LC={apiKey:"API_KEY",authDomain:"PROJECT_ID.firebaseapp.com",databaseURL:"https://quiz-ef7f5-default-rtdb.europe-west1.firebasedatabase.app/",projectId:"PROJECT_ID",storageBucket:"PROJECT_ID.appspot.com",messagingSenderId:"SENDER_ID",appId:"APP_ID",measurementId:"G-MEASUREMENT_ID",storageBucket:"gs://quiz-ef7f5.appspot.com"},Zh=U_(LC),be=ja(Zh),jn=z(ja()),Ae=ja(),Yt=pC(Zh);Kt(Yt,"some-child");let ge,Hc=[],st,qn,Xr=[],Je,qe,Lt,A,mn,Vn,Ms=0,Os,Jr,jc=0;const p={components:{Game:ye},data(){return{firebaseLoaded:function(){jc++,jc>3&&QC.data().closeLoader()},setPackData:function(t){if(t.isGlobal){if(Vn||Os)do Je=Number(String(Math.pow(10,4)*Math.random()).replace(".",0).slice(0,12));while(Object.keys(Os).findIndex(n=>n==Je)!==-1&&Object.keys(Vn).findIndex(n=>n==Je)!==-1);else Je=Number(String(Math.pow(10,4)*Math.random()).replace(".",0).slice(0,12));t.ID=Je,le(z(be,`packs/${Je}`),t)}else{if(Vn=localStorage.getItem("localPacks")?JSON.parse(localStorage.getItem("localPacks")):null,Vn||Os)do Je=Number(String(Math.pow(10,4)*Math.random()).replace(".",0).slice(0,12));while(Vn&&Object.keys(Vn).findIndex(n=>n==Je));else Je=Number(String(Math.pow(10,4)*Math.random()).replace(".",0).slice(0,12));t.ID=Je,t={[Je]:t},localStorage.setItem("localPacks",JSON.stringify(t))}if(t.rounds){for(let n=0;n<t.rounds.length;n++)if(Array.from(t.rounds[n].mediaFiles).filter(i=>i!=="").length>0)for(let i=0;i<Array.from(t.rounds[n].mediaFiles).length;i++)Array.from(t.rounds[n].mediaFiles)[i].type!==void 0&&Gc(Kt(Yt,`packs/${Je}/${n}/${i}`),Array.from(t.rounds[n].mediaFiles)[i]).then(r=>{})}let e=Array.isArray(JSON.parse(localStorage.getItem("likedPacks")))?JSON.parse(localStorage.getItem("likedPacks")):[];e.push(Je),localStorage.setItem("likedPacks",JSON.stringify(e))},getQnFile:function(t,e){Yr(Kt(Yt,`packs/${A.pickedPack.ID}/${t}/${e}`)).then(n=>{$c(Kt(Yt,`packs/${A.pickedPack.ID}/${t}/${e}`)).then(s=>{switch(s.contentType.slice(0,5)){case"image":document.getElementById("mediaFile").insertAdjacentHTML("beforeend",`<img src="${n}" alt="file" class="fileMediaElement" importance="high" loading="eager">`);break;case"video":document.getElementById("mediaFile").insertAdjacentHTML("beforeend",`<video class="fileMediaElement" autoplay autobuffer preload="auto"><source src="${n}"></video>`);break;case"audio":document.getElementById("mediaFile").insertAdjacentHTML("beforeend",`<audio class="fileMediaElement" autoplay><source src="${n}"></audio>`);break}})})},getPacksData:async function(){Wn(At(jn,"packs/")).then(t=>{if(t.exists())return Os=t.val(),this.firebaseLoaded(),t.val();this.firebaseLoaded()})},authFirebase:async function(){localStorage.getItem("uid")===null?Wn(At(jn,"users/")).then(t=>{t.exists()&&(Hc=Object.keys(t.val()));do ge=Number(String(Math.pow(10,4)*Math.random()).replace(".",0).slice(0,12)),st=`User${ge.toString().substring(0,4)}`;while(Hc.findIndex(e=>e==ge)!==-1);le(z(be,`users/${ge}`),{name:st}).then(()=>{localStorage.setItem("uid",ge),localStorage.setItem("userName",st),this.firebaseLoaded()})}).catch(t=>{console.error(t)}):(ge=localStorage.getItem("uid"),st=localStorage.getItem("userName"),this.firebaseLoaded())},getUserAvatar:function(){Yr(Kt(Yt,`avatars/${ge}`)).then(t=>{$c(Kt(Yt,`avatars/${ge}`)).then(e=>{e.contentType.slice(0,5)=="image"&&document.getElementById("userMenuIcon")&&(document.getElementById("userMenuIcon")&&(document.getElementById("userMenuIcon").src=t),Jr=t),this.firebaseLoaded()})}).catch(t=>{switch(t.code){case"storage/object-not-found":Jr="./img/defaultIcon.png";break}this.firebaseLoaded()})},setUserAvatarL:function(t){Gc(Kt(Yt,`avatars/${ge}`),t).then(e=>{})},setUserName:function(t){st=t,le(z(be,`users/${ge}`),{name:st}).then(()=>{localStorage.setItem("userName",st)})},createGame:function(t,e,n,s,i,r,o,a){if(localStorage.getItem("currentGame")!==void 0&&this.gameRooms[localStorage.getItem("currentGame")]!==void 0&&this.gameRooms[localStorage.getItem("currentGame")].players!==void 0)for(let l=0;l<Object.entries(this.gameRooms[localStorage.getItem("currentGame")].players).length;l++)Object.entries(this.gameRooms[localStorage.getItem("currentGame")].players)[l][1].id==ge&&(Object.entries(this.gameRooms[localStorage.getItem("currentGame")].players)[l][1].inGame=!1,le(z(Ae,`rooms/${localStorage.getItem("currentGame")}/players/${l}`),{}));Wn(At(jn,"rooms/")).then(l=>{if(l.exists())Xr=Object.keys(l.val()),Xr.shift();else return qn=Number(String(Math.pow(10,4)*Math.random()).replace(".",0).slice(0,4))}).catch(l=>{console.error(l)});do qn=Number(String(Math.pow(10,4)*Math.random()).replace(".",0).slice(0,4));while(Xr.findIndex(l=>l==qn)!==-1);A={name:t,host:{id:ge,name:st},answerType:e,toJoin:n,isHost:i,onWrongAnswer:r,pickedPack:s,ID:qn,started:!1,timeOnPickQuestion:o,timeOnGiveAnswer:a,gameLine:{turn:!1,pikedQuestion:!1,voiting:!1,answer:!1,finished:!1,wrongAnswer:!1,paused:!1,round:0},players:[{id:ge,name:st,inGame:!0}]},ye.data().pickedGame=A,le(z(be,`rooms/${qn}`),A).then(()=>{localStorage.setItem("currentGame",qn),Lt=[],Lt.push({id:ge,name:st,inGame:!0}),Bi.push("/game").then(()=>{ye.data().startGame()})})},getGameRooms:function(){Wn(At(jn,"rooms/")).then(t=>{if(t.exists()&&(qe=t.val(),delete qe.test),qe!==void 0)for(let e=0;e<Object.entries(qe).length;e++){let n=[];if(Object.entries(qe)[e][1].players!==void 0)for(let s=0;s<Object.entries(qe)[e][1].players.length;s++)Object.entries(qe)[e][1].players[s]!==null&&Object.entries(qe)[e][1].players[s]!==void 0&&Object.entries(qe)[e][1].players[s].inGame==!0&&n.push(Object.entries(qe)[e][1].players[s]);n.length<1&&le(z(Ae,`rooms/${Object.entries(qe)[e][0]}`),{})}this.firebaseLoaded()}).catch(t=>{this.firebaseLoaded(),console.error(t)})},joinGameRoom:function(t){if(localStorage.getItem("currentGame")!==void 0&&localStorage.getItem("currentGame")!==t&&this.gameRooms[localStorage.getItem("currentGame")]!==void 0&&this.gameRooms[localStorage.getItem("currentGame")].players!==void 0)for(let e=0;e<Object.entries(this.gameRooms[localStorage.getItem("currentGame")].players).length;e++)Object.entries(this.gameRooms[localStorage.getItem("currentGame")].players)[e][1].id==ge&&(Object.entries(this.gameRooms[localStorage.getItem("currentGame")].players)[e][1].inGame=!1,le(z(Ae,`rooms/${localStorage.getItem("currentGame")}/players/${e}`),{}));Wn(At(jn,`rooms/${t}/`)).then(e=>{e.exists()&&(A=e.val(),Lt=[],Lt=e.val().players)}).catch(e=>{console.error(e)}).then(()=>{let e=Lt.findIndex(n=>n.id==ge);e==-1?(Lt.push({id:ge,name:st,inGame:!0}),le(z(be,`rooms/${t}/players`),Lt).then(()=>{Bi.push("/game").then(()=>{ye.data().startGame()})})):(Lt[e].inGame=!0,Bi.push("/game").then(()=>{ye.data().startGame()}))}).then(()=>{localStorage.setItem("currentGame",t);let e=Lt.findIndex(r=>r.id==ge);const n=z(Ae,`rooms/${t}/players/${e}/inGame`),s=z(Ae,`users/${ge}/lastOnline`),i=z(Ae,".info/connected");ut(i,r=>{r.val()===!0&&(Mc(n).remove(),le(n,!0),Mc(s).set(uw()))}),ge==A.host.id&&le(z(Ae,`rooms/${t}/gameLine/paused`),!1).then(()=>{})})},joinByCode:function(){Wn(At(jn,"rooms/")).then(t=>{t.exists()&&(qe=t.val())}).then(()=>{Object.keys(qe).findIndex(t=>t==document.getElementById("codeToJoinGameInp").value)!==-1&&this.joinGameRoom(document.getElementById("codeToJoinGameInp").value)})},leaveGame:function(){let t=A.players.filter(e=>e.inGame==!0);A.gameLine.finished===!0&&t.length<2?le(z(Ae,`rooms/${localStorage.getItem("currentGame")}`),null).then(()=>{ge==A.host.id,document.location.reload(),localStorage.setItem("currentGame",void 0)}):(ge==A.host.id?le(z(Ae,`rooms/${localStorage.getItem("currentGame")}/gameLine/paused`),!0).then(()=>{document.location.reload()}):document.location.reload(),localStorage.setItem("currentGame",void 0))},getRandomPlayer:function(){let t=[];for(let e=0;e<A.players.length;e++)A.players[e]!==null&&A.players[e]!==void 0&&A.players[e].inGame==!0&&t.push(A.players[e]);return t[Math.floor(Math.random()*t.length)].id},startGame:function(){mn=0,le(z(be,`rooms/${localStorage.getItem("currentGame")}/started`),!0)},nextTurn:function(){mn++,mn>A.players.length-1&&(A.isHost=="Host"?mn=1:mn=0),le(z(be,`rooms/${localStorage.getItem("currentGame")}/gameLine/turn`),A.players[mn]),le(z(be,`rooms/${localStorage.getItem("currentGame")}/gameLine/voiting`),!1)},informPickedQuestion:function(t){le(z(be,`rooms/${localStorage.getItem("currentGame")}/gameLine/pikedQuestion`),t)},informWrongAnswer:function(t){le(z(be,`rooms/${localStorage.getItem("currentGame")}/gameLine/wrongAnswer`),t)},updatePlayerPoints:function(){let t=A.players.findIndex(o=>o.id==A.gameLine.turn.id),e=Math.abs(A.gameLine.pikedQuestion-Math.floor(A.gameLine.pikedQuestion/Array.from(document.getElementsByClassName("points")).length)*Array.from(document.getElementsByClassName("points")).length),n=A.pickedPack.rounds[Ms].points[e];A.players[t].points||(A.players[t].points=0);let s=Object.values(A.gameLine.voiting).filter(o=>o==!0),i=Object.values(A.gameLine.voiting).filter(o=>o==!1),r=[];for(let o=0;o<A.players.length;o++)A.players[o]!==null&&A.players[o]!==void 0&&A.players[o].inGame==!0&&r.push(A.players[o]);Math.ceil(r.length/2)-1<s.length?(A.players[t].points+=n,ye.data().nextTurn()):Math.ceil(r.length/2)-1<i.length?(A.onWrongAnswer=="MinusPoints"&&(A.players[t].points-=n),ye.data().nextTurn()):r.length-1==Object.values(A.gameLine.voiting).length&&ye.data().nextTurn(),le(z(be,`rooms/${localStorage.getItem("currentGame")}/players`),this.pickedGame.players)},informVoiting:function(t){t=t=="Right",le(z(be,`rooms/${localStorage.getItem("currentGame")}/gameLine/voiting/${ge}`),t)},hostVoited:function(t){t=t=="Right";let e=[];for(let n=0;n<A.players.length;n++)A.players[n]!==null&&A.players[n]!==void 0&&A.players[n].inGame==!0&&e.push(A.players[n]);for(let n=0;n<e.length;n++)le(z(be,`rooms/${localStorage.getItem("currentGame")}/gameLine/voiting/${e[n].id}`),t)},updatePointsByHost:function(t,e){let n=A.players.filter(i=>i.inGame==!0),s=A.players.findIndex(i=>i==n[t]);le(z(be,`rooms/${localStorage.getItem("currentGame")}/players/${s}/points`),e)},nextRound:function(){Ms<A.pickedPack.rounds.length-1?(Ms++,le(z(be,`rooms/${localStorage.getItem("currentGame")}/gameLine/pikedQuestion`),!1),le(z(be,`rooms/${localStorage.getItem("currentGame")}/gameLine/round/`),Ms),ye.data().nextRound()):(le(z(be,`rooms/${localStorage.getItem("currentGame")}/gameLine/finished/`),!0),ye.data().announceWinner())},pauseGame:function(){le(z(be,`rooms/${localStorage.getItem("currentGame")}/gameLine/paused/`),!0)},resumeGame:function(){le(z(be,`rooms/${localStorage.getItem("currentGame")}/gameLine/paused/`),!1)},setGameDataListeners:function(){ut(z(Ae,`rooms/${A.ID}/players`),t=>{if(t.val()!==null){let e=A.players.filter(s=>s.inGame==!0),n=t.val().filter(s=>s.inGame==!0);if(e.length==n.length&&e.length!==1)A.players=t.val(),ye.data().updatePlayerPoints();else{A.players=t.val(),A.players.filter(r=>r.inGame==!1||r.inGame==null||r.inGame==null).findIndex(r=>r.id==A.gameLine.turn.id)!==-1&&this.nextTurn();let i=A.players.filter(r=>r.inGame==!0);for(let r=0;r<i.length;r++)Yr(Kt(Yt,`avatars/${i[r].id}`)).then(o=>{document.getElementsByClassName("playerAvatars")[r].src=o}).catch(o=>{switch(o.code){case"storage/object-not-found":document.getElementsByClassName("playerAvatars")[r].src="./img/defaultIcon.png";break}}),ye.data().showPlayers()}}}),ut(z(Ae,`rooms/${A.ID}/gameLine/turn`),t=>{t.val()!==null&&(A.gameLine.turn=t.val(),document.getElementById("questionBlock").style.display="none",document.getElementById("tableWithQuestions").style.display="grid",A.gameLine.turn&&ye.data().onQuestionPick())}),ut(z(Ae,`rooms/${A.ID}/gameLine/pikedQuestion`),t=>{t.val()!==null&&(A.gameLine.pikedQuestion=t.val(),(A.gameLine.pikedQuestion||A.gameLine.pikedQuestion===0)&&ye.data().onGetQuestion())}),ut(z(Ae,`rooms/${A.ID}/gameLine/voiting`),t=>{t.val()!==null&&(A.gameLine.voiting=t.val(),A.gameLine.voiting&&this.updatePlayerPoints())}),ut(z(Ae,`rooms/${A.ID}/started`),t=>{t.val()!==null&&(A.started=t.val(),A.started&&(mn=0,ye.data().showGameInfo()))}),ut(z(Ae,`rooms/${A.ID}/gameLine/answer/`),t=>{t.val()!==null&&(A.gameLine.answer=t.val(),ye.data().onAnswered())}),ut(z(Ae,`rooms/${A.ID}/gameLine/round/`),t=>{t.val()!==null&&t.val()!==A.gameLine.round&&(A.gameLine.round=t.val(),ye.data().nextRound())}),ut(z(Ae,`rooms/${A.ID}/gameLine/finished/`),t=>{t.val()!==null&&(A.gameLine.finished=t.val(),A.gameLine.finished&&ye.data().announceWinner())}),ut(z(Ae,`rooms/${A.ID}/gameLine/wrongAnswer`),t=>{t.val()!==null&&(A.gameLine.wrongAnswer=t.val(),ye.data().wrongAnswersAdd(A.gameLine.wrongAnswer))}),ut(z(Ae,`rooms/${A.ID}/gameLine/paused`),t=>{t.val()!==null&&(A.gameLine.paused=t.val(),ye.data().pauseGame())})},onAnswer:function(t="No Answer",e){le(z(be,`rooms/${localStorage.getItem("currentGame")}/gameLine/answer/`),{answer:t,turn:e})},pickedGame:A,gameRooms:qe,uid:ge,userName:st,packs:Os,round:Ms,myIcon:Jr}}};const BC={data(){return{userName:p.data().userName,myIcon:p.data().myIcon,onUserName:function(t){let e=t.target.value,n=p.data().userName;e.length>3?p.data().setUserName(e):t.target.value=n},changeIcon:function(){document.getElementById("chooseAvatarInp").click()},onChangeIcon:function(t){t.target.files[0].type.slice(0,5)=="image"&&(p.data().setUserAvatarL(t.target.files[0]),document.getElementById("userMenuIcon").src=window.URL.createObjectURL(t.target.files[0]))}}},mounted(){document.getElementById("userMenuIcon").src||(p.data().myIcon?document.getElementById("userMenuIcon").src=p.data().myIcon:document.getElementById("userMenuIcon").src="img/defaultIcon.png")}},DC={id:"menu"},FC=ju('<div id="gameName" data-v-02aeda47><svg width="87" height="98" viewBox="0 0 87 98" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-02aeda47><path d="M82.0208 80.8669L83.1986 79.2499L81.8792 77.7461L71.2033 65.5785C71.3668 64.0589 71.498 61.6763 71.5396 58.8335C71.5983 54.8211 71.4811 49.6458 70.9642 44.1205C70.4481 38.6024 69.5286 32.6812 67.9632 27.199C66.4056 21.7435 64.1619 16.5552 60.8983 12.643C54.3021 4.73583 47.2195 2.32363 40.9369 2.50989C34.8207 2.69122 29.7871 5.32802 27.1193 6.86688C23.5654 8.91691 18.1076 12.995 13.5773 18.1847C9.67393 22.6561 6.62571 27.977 4.67261 32.6371C2.39496 38.0717 1.69621 46.8007 3.60492 56.3383C5.52841 65.9497 10.143 76.6231 18.7919 85.936C25.9297 93.6217 33.6371 95.9164 40.4369 95.4402C46.395 95.0228 51.4796 92.4951 54.7487 89.9818L70.0802 94.4528L71.7666 94.9446L72.8008 93.5247L82.0208 80.8669ZM21.9578 41.2196C23.3823 34.814 27.0244 30.1921 30.921 27.0897C34.8041 23.9982 38.7457 22.5666 40.6676 22.3299C41.5097 22.344 42.5715 22.4951 43.5474 22.8117C44.6169 23.1587 45.2841 23.6059 45.5866 23.9876C46.7666 25.4766 47.7597 26.9759 49.5611 33.5222C50.9709 38.6455 52.5524 51.4288 53.1732 57.3197C53.4203 59.6642 53.2965 62.3929 51.7292 65.8019C51.3125 66.7085 50.2806 68.1341 48.9485 69.6427C47.6459 71.118 46.2692 72.4338 45.346 73.14C42.1679 75.5711 39.2154 75.6257 36.4113 74.3412C33.4073 72.9651 30.429 69.9563 27.9021 65.9788C23.4933 59.039 20.0152 49.9549 21.9578 41.2196Z" fill="#E17BB3" stroke="#145367" stroke-width="5" data-v-02aeda47></path></svg><svg width="75" height="98" viewBox="0 0 75 98" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-02aeda47><path d="M35.7835 94.7552C35.7916 94.7553 35.7994 94.7554 35.8068 94.7555C35.8091 94.7556 35.8114 94.7558 35.8138 94.7559C35.8692 94.7589 35.9437 94.7624 36.0362 94.7655C36.2211 94.7716 36.4782 94.7759 36.7993 94.7715C37.4409 94.7625 38.3414 94.7181 39.4326 94.5801C41.611 94.3045 44.58 93.6521 47.774 92.1409C54.2593 89.0726 61.3765 82.5984 64.8119 69.3852L64.845 69.2578L64.8646 69.1277L72.3682 19.2135C73.3832 12.4618 68.1545 6.38827 61.3269 6.38828C55.4731 6.38828 50.6382 10.9262 50.173 16.7271C48.3557 39.3868 46.6777 53.749 45.0745 62.8337C44.0435 68.6759 39.8382 71.6596 35.7936 71.9296C31.8313 72.194 27.7571 69.8886 26.6439 64.1974C24.9141 55.3544 24.1749 40.403 25.7293 15.1077C26.1109 8.89804 21.4777 3.38497 15.1957 2.91218C9.09386 2.45296 3.66322 6.92546 3.26465 13.1473C2.54747 24.3429 1.83697 44.8595 4.36962 64.2968C6.33236 79.3602 14.1415 87.1052 21.6065 90.9745C25.2834 92.8803 28.821 93.8211 31.4346 94.288C32.745 94.5221 33.8342 94.639 34.6076 94.6975C34.9947 94.7267 35.3037 94.7414 35.523 94.7488C35.6326 94.7524 35.7199 94.7543 35.7835 94.7552Z" fill="#E17BB3" stroke="#145367" stroke-width="5" data-v-02aeda47></path></svg><svg width="74" height="102" viewBox="0 0 74 102" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-02aeda47><path d="M12.2125 8.31622C6.10439 9.24439 1.90522 14.9484 2.83339 21.0565L2.86595 21.2707C3.77614 27.2605 9.36966 31.3783 15.3594 30.4681C18.6191 29.9728 21.6632 32.2138 22.1585 35.4734L27.2321 68.8615C27.7274 72.1212 25.4864 75.1652 22.2268 75.6606C16.237 76.5708 12.1192 82.1643 13.0294 88.1541L13.1325 88.8325C14.0996 95.197 20.043 99.5724 26.4075 98.6053L34.1029 97.4359L61.5604 93.2635C67.9249 92.2964 72.3003 86.353 71.3332 79.9885L71.0774 78.3052C70.2515 72.8704 65.1762 69.1341 59.7414 69.9599C57.0367 70.3709 54.5109 68.5115 54.0999 65.8068L48.721 30.409C48.31 27.7043 50.1694 25.1785 52.8741 24.7675C58.3089 23.9416 62.0452 18.8664 61.2193 13.4316L61.0341 12.2125C60.1059 6.10437 54.4019 1.90522 48.2938 2.83339L12.2125 8.31622Z" fill="#E17BB3" stroke="#145367" stroke-width="5" data-v-02aeda47></path></svg><svg width="77" height="100" viewBox="0 0 77 100" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-02aeda47><path d="M10.4265 3.00331C5.68192 2.12252 1.66575 6.5365 2.98939 11.177L5.92478 21.4682C6.68089 24.119 9.02683 26.0047 11.7782 26.1731L35.7368 27.64C40.148 27.9101 42.4552 33.0093 39.7462 36.5011L6.17428 79.7737C0.833797 86.6573 5.71634 96.6753 14.4286 96.7099L65.4116 96.9123C70.1363 96.931 73.3019 92.0625 71.3679 87.7517L68.2809 80.8706C67.2915 78.6653 65.1601 77.1911 62.7476 77.0434L44.6398 75.9347C40.975 75.7103 39.107 71.428 41.4356 68.5892L71.683 31.7143C77.2322 24.9492 73.4935 14.7112 64.8906 13.1141L10.4265 3.00331Z" fill="#E17BB3" stroke="#145367" stroke-width="5" data-v-02aeda47></path></svg></div>',1),GC={id:"meunNavPanel"},$C=mi("Join Game"),UC=mi("Create Game"),WC=mi("Find Pack"),HC=mi("Create Pack"),jC={id:"menuUserNickAva"},qC=["value"];function VC(t,e,n,s,i,r){const o=Pu("router-link");return mr(),Uu("div",DC,[FC,Re("div",GC,[Me(o,{class:"menuNavBtns",to:"/joinGame"},{default:Ds(()=>[$C]),_:1}),Me(o,{class:"menuNavBtns",to:"/createGame"},{default:Ds(()=>[UC]),_:1}),Me(o,{class:"menuNavBtns",to:"/findPack"},{default:Ds(()=>[WC]),_:1}),Me(o,{class:"menuNavBtns",to:"/createPack"},{default:Ds(()=>[HC]),_:1})]),Re("div",jC,[Re("img",{id:"userMenuIcon",width:"48px",alt:"icon",onClick:e[0]||(e[0]=a=>i.changeIcon())}),Re("input",{type:"text",id:"inputUserNick",value:i.userName,onChange:e[1]||(e[1]=a=>i.onUserName(a))},null,40,qC),Re("input",{id:"chooseAvatarInp",type:"file",onInput:e[2]||(e[2]=a=>i.onChangeIcon(a))},null,32)])])}const zC=ia(BC,[["render",VC],["__scopeId","data-v-02aeda47"]]),Bi=Rg({history:Hp("/Quiz/"),routes:[{path:"/",name:"Menu",component:zC},{path:"/joinGame",name:"joinGame",component:()=>Ts(()=>import("./JoinGame.312f3a4f.js"),["assets/JoinGame.312f3a4f.js","assets/JoinGame.03d9a7a6.css"])},{path:"/createGame",name:"createGame",component:()=>Ts(()=>import("./CreateGame.5e3718b6.js"),["assets/CreateGame.5e3718b6.js","assets/CreateGame.0e6b3070.css","assets/Packs.048425e5.js","assets/Packs.dfa199a0.css"])},{path:"/findPack",name:"findPack",component:()=>Ts(()=>import("./FindPack.cd5ab1ea.js"),["assets/FindPack.cd5ab1ea.js","assets/FindPack.6e8cedca.css","assets/Packs.048425e5.js","assets/Packs.dfa199a0.css"])},{path:"/createPack",name:"createPack",component:()=>Ts(()=>import("./CreatePack.4a8d91b1.js"),["assets/CreatePack.4a8d91b1.js","assets/CreatePack.2a735cb1.css"])},{path:"/game",name:"game",component:()=>Ts(()=>Promise.resolve().then(()=>OC),void 0)}]});const ef=wp(kp);ef.use(Bi);ef.mount("#app");Array.prototype.findLastIndex=function(t){let e=this.slice();return e.length-e.reverse().findIndex(t)};document.getElementById("app").style.display="none";p.data().authFirebase();p.data().getPacksData();p.data().getGameRooms();p.data().getUserAvatar();const QC={data(){return{closeLoader:function(){document.getElementById("app").style.display="block",document.getElementById("loader").classList.add("closeLoader"),document.getElementById("loader").addEventListener("animationend",function(){document.getElementById("loader").style.display="none"})}}}};export{Bt as F,ia as _,Re as a,XC as b,Uu as c,ju as d,Me as e,p as f,YC as g,Wu as h,Bi as i,Uo as n,mr as o,Pu as r,KC as t,Ds as w};
