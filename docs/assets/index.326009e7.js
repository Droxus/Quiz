 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iE=Math.log(2);class rE{constructor(e){const n=r=>parseInt(Math.log(r)/iE,10),s=r=>parseInt(Array(r+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=s(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Qi=function(t,e,n,s){t.sort(e);const i=function(l,c){const u=c-l;let d,h;if(u===0)return null;if(u===1)return d=t[l],h=n?n(d):d,new Ne(h,d.node,Ne.BLACK,null,null);{const g=parseInt(u/2,10)+l,y=i(l,g),N=i(g+1,c);return d=t[g],h=n?n(d):d,new Ne(h,d.node,Ne.BLACK,y,N)}},r=function(l){let c=null,u=null,d=t.length;const h=function(y,N){const k=d-y,B=d;d-=y;const $=i(k+1,B),H=t[k],W=n?n(H):H;g(new Ne(W,H.node,N,null,$))},g=function(y){c?(c.left=y,c=y):(u=y,c=y)};for(let y=0;y<l.count;++y){const N=l.nextBitIsOne(),k=Math.pow(2,l.count-(y+1));N?h(k,Ne.BLACK):(h(k,Ne.BLACK),h(k,Ne.RED))}return u},o=new rE(t.length),a=r(o);return new Qe(s||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ze{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let s;try{s=Ze.makeFromUrl(e,n)}catch{return new Ze(e,"")}if(s.path==="")return s;throw Cw(e)}static makeFromUrl(e,n){let s=null;const i="([A-Za-z0-9.\\-_]+)";function r(W){W.path.charAt(W.path.length-1)==="/"&&(W.path_=W.path_.slice(0,-1))}const o="(/(.*))?$",a=new RegExp("^gs://"+i+o,"i"),l={bucket:1,path:3};function c(W){W.path_=decodeURIComponent(W.path)}const u="v[A-Za-z0-9_]+",d=n.replace(/[.]/g,"\\."),h="(/([^?#]*).*)?$",g=new RegExp(`^https?://${d}/${u}/b/${i}/o${h}`,"i"),y={bucket:1,path:3},N=n===Oh?"(?:storage.googleapis.com|storage.cloud.google.com)":n,k="([^?#]*)",B=new RegExp(`^https?://${N}/${i}/${k}`,"i"),H=[{regex:a,indices:l,postModify:r},{regex:g,indices:y,postModify:c},{regex:B,indices:{bucket:1,path:2},postModify:c}];for(let W=0;W<H.length;W++){const Ie=H[W],Le=Ie.regex.exec(e);if(Le){const at=Le[Ie.indices.bucket];let vt=Le[Ie.indices.path];vt||(vt=""),s=new Ze(at,vt),Ie.postModify(s);break}}if(s==null)throw ww(e);return s}}class Aw{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rw(t,e,n){let s=1,i=null,r=null,o=!1,a=0;function l(){return a===2}let c=!1;function u(...k){c||(c=!0,e.apply(null,k))}function d(k){i=setTimeout(()=>{i=null,t(g,l())},k)}function h(){r&&clearTimeout(r)}function g(k,...B){if(c){h();return}if(k){h(),u.call(null,k,...B);return}if(l()||o){h(),u.call(null,k,...B);return}s<64&&(s*=2);let H;a===1?(a=2,H=0):H=(s+Math.random())*1e3,d(H)}let y=!1;function N(k){y||(y=!0,h(),!c&&(i!==null?(k||(a=2),clearTimeout(i),d(0)):k||(a=1)))}return d(0),r=setTimeout(()=>{o=!0,N(!0)},n),N}function Sw(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
